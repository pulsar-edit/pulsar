...
- They could read the CONTRIBUTING.md file which [has a section](https://github.com/atom/Pulsar/blob/master/CONTRIBUTING.md#Pulsar-and-packages) that explains where to find the repos for core packages and how to contribute, but we don't really have a clear pointer to that in our README.md
...
[Pulsar-dark-syntax]: https://github.com/atom/Pulsar-dark-syntax
[Pulsar-dark-ui]: https://github.com/atom/Pulsar-dark-ui
[Pulsar-light-syntax]: https://github.com/atom/Pulsar-light-syntax
[Pulsar-light-ui]: https://github.com/atom/Pulsar-light-ui
[autocomplete-Pulsar-api]: https://github.com/atom/autocomplete-Pulsar-api
