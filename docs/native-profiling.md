# Profiling the Pulsar Render Process on macOS with Instruments
...
* Based on this version, download the appropriate Electron symbols from the [releases](https://github.com/electron/electron/releases) page.
