...
describe("MarkerLayer", function() {
  ...
  describe("when maintainHistory is enabled for the layer", function() {
    ...
    it("restores the state of all markers in the layer on undo and redo", function() {
      ...
      const marker1 = layer3.markRange([[0, 0], [0, 0]], {invalidate: 'never'});
      const marker2 = layer3.markRange([[0, 0], [0, 0]], {invalidate: 'never'});
      ...
      buffer.transact(function() {
        ...
        const marker3 = layer3.markRange([[0, 0], [0, 3]], {invalidate: 'never'});
        const marker4 = layer3.markRange([[1, 0], [1, 3]], {invalidate: 'never'});
  ...
  describe("::clear()", () => {
    it("destroys all of the layer's markers", function(done) {
      ...
      markerLayer.onDidUpdate(function() {
        ...
        if ((markerLayerUpdateCount === 1) && (displayMarkerLayerUpdateCount === 1)) { done(); }
      });
