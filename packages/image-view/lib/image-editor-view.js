...
module.exports = class ImageEditorView {
  constructor(editor) {
    ...
    this.disposables.add(
      new Disposable(() => {
        this.refs.whiteTransparentBackgroundButton.removeEventListener("click", clickHandler);
      }),
    );
    this.refs.blackTransparentBackgroundButton.addEventListener("click", clickHandler);
    this.disposables.add(
      new Disposable(() => {
        this.refs.blackTransparentBackgroundButton.removeEventListener("click", clickHandler);
      }),
    );
    this.refs.transparentTransparentBackgroundButton.addEventListener("click", clickHandler);
    this.disposables.add(
      new Disposable(() => {
        this.refs.transparentTransparentBackgroundButton.removeEventListener("click", clickHandler);
      }),
    );
    ...
    this.disposables.add(
      new Disposable(() => {
        this.refs.zoomOutButton.removeEventListener("click", zoomOutClickHandler);
      }),
    );
    ...
    this.disposables.add(
      new Disposable(() => {
        this.refs.resetZoomButton.removeEventListener("click", resetZoomClickHandler);
      }),
    );
    ...
    this.disposables.add(
      new Disposable(() => {
        this.refs.zoomToFitButton.removeEventListener("click", zoomToFitClickHandler);
      }),
    );
  }
    ...
    return $.div(
      ...
      $.div(
        ...
        $.div(
          ...
          $.button({ className: "btn reset-zoom-button", ref: "resetZoomButton" }, "Auto"),
