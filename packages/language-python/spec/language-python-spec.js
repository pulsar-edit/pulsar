describe("Python settings", () => {
  ...
  it("matches lines correctly using the increaseIndentPattern", () => {
    const increaseIndentRegex = languageMode.increaseIndentRegexForScopeDescriptor([
      "source.python",
    ]);
    ...
    expect(
      increaseIndentRegex.findNextMatchSync('  async with open("filename") as f:'),
    ).toBeTruthy();
  ...
  it("matches lines correctly using the decreaseIndentPattern", () => {
    const decreaseIndentRegex = languageMode.decreaseIndentRegexForScopeDescriptor([
      "source.python",
    ]);
