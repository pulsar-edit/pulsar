describe("Java grammar", function () {
  ...
  it("tokenizes this with `.this` class", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "this",
      scopes: ["source.java", "variable.language.this.java"],
    });
  });
  ...
  it("tokenizes braces", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "(",
      scopes: ["source.java", "punctuation.bracket.round.java"],
    });
    ...
    expect(tokens[10]).toEqual({
      value: "[",
      scopes: ["source.java", "punctuation.bracket.square.java"],
    });
...
`);
    ...
    expect(lines[0][3]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.java", "punctuation.bracket.angle.java"],
    });
    ...
    expect(lines[2][8]).toEqual({
      value: " ",
      scopes: ["source.java", "meta.class.java", "meta.class.body.java", "meta.method.java"],
    });
  ...
  it("tokenizes punctuation", function () {
    ...
    expect(tokens[9]).toEqual({
      value: ";",
      scopes: ["source.java", "punctuation.terminator.java"],
    });
    ...
    expect(tokens[1]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.method-call.java", "punctuation.separator.period.java"],
    });
    expect(tokens[5]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.method-call.java", "punctuation.separator.delimiter.java"],
    });
    ...
    expect(tokens[2]).toEqual({
      value: ".",
      scopes: ["source.java", "punctuation.separator.period.java"],
    });
  ...
  it("tokenizes the `package` keyword", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "package",
      scopes: ["source.java", "meta.package.java", "keyword.other.package.java"],
    });
    expect(tokens[1]).toEqual({ value: " ", scopes: ["source.java", "meta.package.java"] });
    expect(tokens[2]).toEqual({
      value: "java",
      scopes: ["source.java", "meta.package.java", "storage.modifier.package.java"],
    });
    expect(tokens[3]).toEqual({
      value: ".",
      scopes: [
    ...
    expect(tokens[7]).toEqual({
      value: ";",
      scopes: ["source.java", "meta.package.java", "punctuation.terminator.java"],
    });
    ...
    expect(tokens[4]).toEqual({
      ...
      scopes: [
        ...
        "meta.package.java",
        "storage.modifier.package.java",
        "invalid.deprecated.package_name_not_lowercase.java",
      ],
    });
  ...
  it("tokenizes the `import` keyword", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "import",
      scopes: ["source.java", "meta.import.java", "keyword.other.import.java"],
    });
    expect(tokens[1]).toEqual({ value: " ", scopes: ["source.java", "meta.import.java"] });
    expect(tokens[2]).toEqual({
      value: "java",
      scopes: ["source.java", "meta.import.java", "storage.modifier.import.java"],
    });
    expect(tokens[3]).toEqual({
      value: ".",
      scopes: [
    ...
    expect(tokens[7]).toEqual({
      value: ";",
      scopes: ["source.java", "meta.import.java", "punctuation.terminator.java"],
    });
    ...
    expect(tokens[2]).toEqual({
      value: "static",
      scopes: ["source.java", "meta.import.java", "storage.modifier.java"],
    });
...
`);
    ...
    expect(lines[0][0]).toEqual({
      value: "module",
      scopes: ["source.java", "meta.module.java", "storage.modifier.java"],
    });
    expect(lines[0][2]).toEqual({
      value: "Provider",
      scopes: ["source.java", "meta.module.java", "entity.name.type.module.java"],
    });
    expect(lines[0][4]).toEqual({
      ...
      scopes: [
        "source.java",
        "meta.module.java",
        "punctuation.section.module.begin.bracket.curly.java",
      ],
    });
    expect(lines[1][1]).toEqual({
      value: "requires",
      scopes: ["source.java", "meta.module.java", "meta.module.body.java", "keyword.module.java"],
    });
    ...
    expect(lines[3][0]).toEqual({
      ...
      scopes: [
        "source.java",
        "meta.module.java",
        "punctuation.section.module.end.bracket.curly.java",
      ],
    });
  });
...
`);
    ...
    expect(lines[2][2]).toEqual({
      value: " comments ",
      scopes: ["source.java", "meta.module.java", "meta.module.body.java", "comment.block.java"],
    });
...
`);
    ...
    expect(lines[13][1]).toEqual({
      value: "Testclass",
      scopes: ["source.java", "meta.definition.variable.java", "storage.type.java"],
    });
...
`);
    ...
    expect(lines[0][0]).toEqual({
      value: "enum",
      scopes: ["source.java", "meta.enum.java", "storage.modifier.java"],
    });
    expect(lines[0][2]).toEqual({
      value: "Letters",
      scopes: ["source.java", "meta.enum.java", "entity.name.type.enum.java"],
    });
    expect(lines[0][4]).toEqual({
      value: "{",
      scopes: [
    ...
    expect(lines[2][1]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.enum.java", "constant.other.enum.java"],
    });
    ...
    expect(lines[9][0]).toEqual({
      value: "}",
      scopes: ["source.java", "meta.enum.java", "punctuation.section.enum.end.bracket.curly.java"],
    });
  });
...
`);
    ...
    expect(lines[1][3]).toEqual({
      value: "(",
      scopes: ["source.java", "meta.enum.java", "punctuation.bracket.round.java"],
    });
    expect(lines[1][5]).toEqual({
      value: "red",
      scopes: ["source.java", "meta.enum.java", "string.quoted.double.java"],
    });
    ...
    expect(lines[2][4]).toEqual({
      value: "1000L",
      scopes: ["source.java", "meta.enum.java", "constant.numeric.decimal.java"],
    });
    expect(lines[2][5]).toEqual({
      value: ")",
      scopes: ["source.java", "meta.enum.java", "punctuation.bracket.round.java"],
    ...
    expect(lines[19][1]).toEqual({
      value: "public",
      scopes: ["source.java", "meta.enum.java", "meta.method.java", "storage.modifier.java"],
    });
    expect(lines[19][3]).toEqual({
      value: "String",
      scopes: [
        "source.java",
        "meta.enum.java",
...
`);
    ...
    expect(lines[1][3]).toEqual({
      value: "{",
      scopes: ["source.java", "meta.enum.java", "punctuation.bracket.curly.java"],
    });
    expect(lines[2][2]).toEqual({
      value: "Override",
      scopes: [
...
`);
    ...
    expect(lines[1][6]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.enum.java", "punctuation.separator.delimiter.java"],
    });
    ...
    expect(lines[8][1]).toEqual({
      value: "{",
      scopes: ["source.java", "meta.enum.java", "punctuation.bracket.curly.java"],
    }); // Begin bracket placed at new line
...
`);
  ...
  it("does not catastrophically backtrack when tokenizing large enums (regression)", function () {
    ...
    const enumContents =
      "AAAAAAAAAAA, BBBBBBBBBB, CCCCCCCCCC, DDDDDDDDDD, EEEEEEEEEE, FFFFFFFFFF, ".repeat(50);
...
`);
    ...
    expect(lines[2][1]).toEqual({
      value: "A",
      scopes: scopeStack.concat(["meta.method.identifier.java", "entity.name.function.java"]),
    });
    expect(lines[2][2]).toEqual({
      value: "(",
      scopes: scopeStack.concat([
    ...
    expect(lines[2][3]).toEqual({
      value: "int",
      scopes: scopeStack.concat(["meta.method.identifier.java", "storage.type.primitive.java"]),
    });
    expect(lines[2][5]).toEqual({
      value: "a",
      scopes: scopeStack.concat(["meta.method.identifier.java", "variable.parameter.java"]),
    });
    expect(lines[2][6]).toEqual({
      value: ",",
      scopes: scopeStack.concat([
    ...
    expect(lines[3][1]).toEqual({
      value: "{",
      scopes: scopeStack.concat(["punctuation.section.method.begin.bracket.curly.java"]),
    });
    expect(lines[4][1]).toEqual({
      value: "super",
      scopes: scopeStack.concat(["meta.method.body.java", "variable.language.java"]),
    });
    expect(lines[5][1]).toEqual({
      value: "this",
      scopes: scopeStack.concat(["meta.method.body.java", "variable.language.this.java"]),
    });
    expect(lines[5][3]).toEqual({
      value: "prop",
      scopes: scopeStack.concat(["meta.method.body.java", "variable.other.object.property.java"]),
    });
    expect(lines[6][1]).toEqual({
      value: "}",
      scopes: scopeStack.concat(["punctuation.section.method.end.bracket.curly.java"]),
    });

    expect(lines[8][1]).toEqual({
      value: "public",
      scopes: scopeStack.concat(["storage.modifier.java"]),
    });
    expect(lines[8][4]).toEqual({
      value: " test ",
      scopes: scopeStack.concat(["comment.block.java"]),
    });
    expect(lines[8][7]).toEqual({
      value: "List",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.java"]),
    });
    expect(lines[8][8]).toEqual({
      value: "<",
      scopes: scopeStack.concat(["meta.method.return-type.java", "punctuation.bracket.angle.java"]),
    });
    expect(lines[8][9]).toEqual({
      value: "Integer",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.generic.java"]),
    });
    ...
    expect(lines[8][13]).toEqual({
      value: " test ",
      scopes: scopeStack.concat(["meta.method.return-type.java", "comment.block.java"]),
    });
    ...
    expect(lines[8][24]).toEqual({
      value: "throws",
      scopes: scopeStack.concat(["meta.throwables.java", "storage.modifier.java"]),
    });
    expect(lines[8][26]).toEqual({
      value: "Exception",
      scopes: scopeStack.concat(["meta.throwables.java", "storage.type.java"]),
    });
    ...
    expect(lines[13][3]).toEqual({
      value: "void",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.primitive.java"]),
    });
    expect(lines[13][5]).toEqual({
      value: "nothing",
      scopes: scopeStack.concat(["meta.method.identifier.java", "entity.name.function.java"]),
    ...
    expect(lines[15][5]).toEqual({
      value: "lang",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.java"]),
    });
    expect(lines[15][7]).toEqual({
      value: "String",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.object.array.java"]),
    });
    expect(lines[15][8]).toEqual({
      value: "[",
      scopes: scopeStack.concat([
        "meta.method.return-type.java",
        "punctuation.bracket.square.java",
    ...
    expect(lines[15][13]).toEqual({
      value: "getString",
      scopes: scopeStack.concat(["meta.method.identifier.java", "entity.name.function.java"]),
    });

    expect(lines[20][1]).toEqual({
      value: "public",
      scopes: scopeStack.concat(["storage.modifier.java"]),
    });
    expect(lines[20][3]).toEqual({
      value: "Map",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.java"]),
    });
    expect(lines[20][4]).toEqual({
      value: "<",
      scopes: scopeStack.concat(["meta.method.return-type.java", "punctuation.bracket.angle.java"]),
    });
    expect(lines[20][5]).toEqual({
      value: "Integer",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.generic.java"]),
    });
    expect(lines[20][8]).toEqual({
      value: "Integer",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.generic.java"]),
    });
    expect(lines[20][9]).toEqual({
      value: ">",
      scopes: scopeStack.concat(["meta.method.return-type.java", "punctuation.bracket.angle.java"]),
    });
    expect(lines[20][11]).toEqual({
      value: "getMap",
      scopes: scopeStack.concat(["meta.method.identifier.java", "entity.name.function.java"]),
    });

    expect(lines[25][1]).toEqual({
      value: "public",
      scopes: scopeStack.concat(["storage.modifier.java"]),
    });
    expect(lines[25][3]).toEqual({
      value: "<",
      scopes: scopeStack.concat(["punctuation.bracket.angle.java"]),
    });
    expect(lines[25][4]).toEqual({
      value: "T",
      scopes: scopeStack.concat(["storage.type.generic.java"]),
    });
    expect(lines[25][6]).toEqual({
      value: "extends",
      scopes: scopeStack.concat(["storage.modifier.extends.java"]),
    });
    expect(lines[25][8]).toEqual({
      value: "Box",
      scopes: scopeStack.concat(["storage.type.generic.java"]),
    });
    expect(lines[25][9]).toEqual({
      value: ">",
      scopes: scopeStack.concat(["punctuation.bracket.angle.java"]),
    });
    expect(lines[25][11]).toEqual({
      value: "T",
      scopes: scopeStack.concat(["meta.method.return-type.java", "storage.type.java"]),
    });
    expect(lines[25][13]).toEqual({
      value: "call",
      scopes: scopeStack.concat(["meta.method.identifier.java", "entity.name.function.java"]),
    });
    expect(lines[25][14]).toEqual({
      value: "(",
      scopes: scopeStack.concat([
        "meta.method.identifier.java",
        "punctuation.definition.parameters.begin.bracket.round.java",
    ...
    expect(lines[25][15]).toEqual({
      value: "String",
      scopes: scopeStack.concat(["meta.method.identifier.java", "storage.type.java"]),
    });
    expect(lines[25][17]).toEqual({
      value: "name",
      scopes: scopeStack.concat(["meta.method.identifier.java", "variable.parameter.java"]),
    });
    expect(lines[25][20]).toEqual({
      value: "Class",
      scopes: scopeStack.concat(["meta.method.identifier.java", "storage.type.java"]),
    });
    expect(lines[25][21]).toEqual({
      value: "<",
      scopes: scopeStack.concat(["meta.method.identifier.java", "punctuation.bracket.angle.java"]),
    });
    expect(lines[25][22]).toEqual({
      value: "T",
      scopes: scopeStack.concat(["meta.method.identifier.java", "storage.type.generic.java"]),
    });
    expect(lines[25][23]).toEqual({
      value: ">",
      scopes: scopeStack.concat(["meta.method.identifier.java", "punctuation.bracket.angle.java"]),
    });
    expect(lines[25][25]).toEqual({
      value: "type",
      scopes: scopeStack.concat(["meta.method.identifier.java", "variable.parameter.java"]),
    });
    expect(lines[25][26]).toEqual({
      value: ")",
      scopes: scopeStack.concat([
        "meta.method.identifier.java",
        "punctuation.definition.parameters.end.bracket.round.java",
  ...
  describe("numbers", function () {
    describe("integers", function () {
      it("tokenizes hexadecimal integers", function () {
        ...
        expect(tokens[0]).toEqual({
          value: "0x0",
          scopes: ["source.java", "constant.numeric.hex.java"],
        });
        ...
        expect(tokens[0]).toEqual({
          value: "0xCF______3_2_A_73_B",
          scopes: ["source.java", "constant.numeric.hex.java"],
        });

        ({ tokens } = grammar.tokenizeLine("0xCF______3_2_A_73_BL"));
        expect(tokens[0]).toEqual({
          value: "0xCF______3_2_A_73_BL",
          scopes: ["source.java", "constant.numeric.hex.java"],
        });
      ...
      it("tokenizes binary literals", function () {
        ...
        expect(tokens[0]).toEqual({
          value: "0b0",
          scopes: ["source.java", "constant.numeric.binary.java"],
        });
        ...
        expect(tokens[0]).toEqual({
          value: "0b10101010010101",
          scopes: ["source.java", "constant.numeric.binary.java"],
        });

        ({ tokens } = grammar.tokenizeLine("0b10_101__010______01_0_101"));
        expect(tokens[0]).toEqual({
          value: "0b10_101__010______01_0_101",
          scopes: ["source.java", "constant.numeric.binary.java"],
        });
      ...
      it("tokenizes octal literals", function () {
        ...
        expect(tokens[0]).toEqual({
          value: "00",
          scopes: ["source.java", "constant.numeric.octal.java"],
        });
        ...
        expect(tokens[0]).toEqual({
          value: "0",
          scopes: ["source.java", "constant.numeric.decimal.java"],
        });
      ...
      it("tokenizes numeric integers", function () {
        ...
        expect(tokens[0]).toEqual({
          value: "2947_39___23__60_3_4______92738l",
          scopes: ["source.java", "constant.numeric.decimal.java"],
        });
    ...
    describe("floats", function () {
      ...
      it("tokenizes numeric floats", function () {
        ...
        expect(tokens[0]).toEqual({
          value: "_1",
          scopes: ["source.java", "variable.other.object.java"],
        });
...
`);
    ...
    expect(lines[2][3]).toEqual({
      value: "final",
      scopes: ["source.java", "meta.class.java", "meta.class.body.java", "storage.modifier.java"],
    });
    expect(lines[2][7]).toEqual({
      value: "finala",
      scopes: [
...
`);
    ...
    expect(lines[2][3]).toEqual({
      value: "g",
      scopes: ["source.java", "meta.definition.variable.java", "variable.other.definition.java"],
    });
    ...
    expect(lines[7][5]).toEqual({
      value: ">",
      scopes: ["source.java", "keyword.operator.comparison.java"],
    });
...
`);
    ...
    expect(lines[2][4]).toEqual({
      value: "int",
      scopes: ["source.java", "meta.definition.variable.java", "storage.type.primitive.java"],
    });
    expect(lines[2][6]).toEqual({
      value: "i",
      scopes: ["source.java", "meta.definition.variable.java", "variable.other.definition.java"],
    ...
    expect(lines[6][12]).toEqual({
      value: "map",
      scopes: ["source.java", "meta.definition.variable.java", "variable.other.definition.java"],
    });
    expect(lines[6][19]).toEqual({
      value: ")",
      scopes: ["source.java", "punctuation.bracket.round.java"],
    });
  });
...
`);
    ...
    expect(lines[1][1]).toEqual({
      value: "var",
      scopes: ["source.java", "meta.definition.variable.local.java", "storage.type.local.java"],
    });
    expect(lines[1][3]).toEqual({
      value: "a",
      scopes: [
...
`);
    ...
    expect(lines[0][4]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.java", "storage.type.generic.java"],
    });
    expect(lines[0][5]).toEqual({ value: " ", scopes: ["source.java", "meta.class.java"] });
    expect(lines[0][6]).toEqual({
      value: "extends",
      scopes: ["source.java", "meta.class.java", "storage.modifier.extends.java"],
    });
    ...
    expect(lines[0][10]).toEqual({
      value: "&",
      scopes: ["source.java", "meta.class.java", "punctuation.separator.types.java"],
    });
    ...
    expect(lines[0][13]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.java", "punctuation.separator.delimiter.java"],
    });
    ...
    expect(lines[2][15]).toEqual({
      value: "HashMap",
      scopes: ["source.java", "meta.class.java", "meta.class.body.java", "storage.type.java"],
    });
...
`);
    ...
    expect(lines[5][5]).toEqual({
      value: "=",
      scopes: ["source.java", "keyword.operator.assignment.java"],
    });
    // check that string does not extend to/include ';'
    expect(lines[5][10]).toEqual({
      value: ";",
      scopes: ["source.java", "punctuation.terminator.java"],
    });
  });
...
`);
    ...
    expect(lines[2][8]).toEqual({
      value: "&&",
      scopes: ["source.java", "keyword.operator.logical.java"],
    });
...
`);
    ...
    expect(lines[2][2]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.definition.variable.java", "punctuation.bracket.angle.java"],
    });
    expect(lines[2][3]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.definition.variable.java", "storage.type.generic.java"],
    });
    ...
    expect(lines[3][5]).toEqual({
      value: "ArrayList",
      scopes: ["source.java", "storage.type.java"],
    });
    expect(lines[3][6]).toEqual({
      value: "<",
      scopes: ["source.java", "punctuation.bracket.angle.java"],
    });
    expect(lines[3][7]).toEqual({
      value: ">",
      scopes: ["source.java", "punctuation.bracket.angle.java"],
...
`);
    ...
    expect(lines[5][7]).toEqual({
      value: "A",
      scopes: ["source.java", "storage.type.generic.java"],
    });
    expect(lines[5][11]).toEqual({
      value: "B",
      scopes: ["source.java", "storage.type.generic.java"],
...
`);
    ...
    expect(lines[2][5]).toEqual({
      value: "<<",
      scopes: ["source.java", "keyword.operator.bitwise.java"],
    });
    expect(lines[2][7]).toEqual({
      value: "12",
      scopes: ["source.java", "constant.numeric.decimal.java"],
...
`);
    ...
    expect(lines[2][13]).toEqual({
      value: "null",
      scopes: ["source.java", "meta.class.java", "meta.class.body.java", "constant.language.java"],
    });
    expect(lines[2][14]).toEqual({
      value: ";",
      scopes: [
  ...
  it("tokenizes lambda expressions", function () {
    ...
    expect(tokens[5]).toEqual({
      value: "->",
      scopes: ["source.java", "storage.type.function.arrow.java"],
    });
    expect(tokens[8]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.method-call.java", "punctuation.separator.period.java"],
    ...
    expect(tokens[13]).toEqual({
      value: "-",
      scopes: ["source.java", "keyword.operator.arithmetic.java"],
    });
  });
  ...
  it("tokenizes `new` statements", function () {
    ...
    expect(tokens[8]).toEqual({
      value: "new",
      scopes: ["source.java", "keyword.control.new.java"],
    });
    expect(tokens[9]).toEqual({ value: " ", scopes: ["source.java"] });
    expect(tokens[10]).toEqual({
      value: "int",
      scopes: ["source.java", "storage.type.primitive.array.java"],
    });
    expect(tokens[11]).toEqual({
      value: "[",
      scopes: ["source.java", "punctuation.bracket.square.java"],
    ...
    expect(tokens[10]).toEqual({
      value: "String",
      scopes: ["source.java", "storage.type.object.array.java"],
    });
    expect(tokens[11]).toEqual({
      value: "[",
      scopes: ["source.java", "punctuation.bracket.square.java"],
    ...
    expect(tokens[13]).toEqual({
      ...
      scopes: [
        "source.java",
        "meta.array-initializer.java",
        "punctuation.section.array-initializer.begin.bracket.curly.java",
      ],
    });
    expect(tokens[14]).toEqual({
      value: '"',
    ...
    expect(tokens[15]).toEqual({
      value: "hi",
      scopes: ["source.java", "meta.array-initializer.java", "string.quoted.double.java"],
    });
    ...
    expect(tokens[18]).toEqual({
      value: " ",
      scopes: ["source.java", "meta.array-initializer.java"],
    });
    expect(tokens[27]).toEqual({
      ...
      scopes: [
        "source.java",
        "meta.array-initializer.java",
        "punctuation.section.array-initializer.end.bracket.curly.java",
      ],
    });
    ...
    expect(tokens[14]).toEqual({
      value: "new",
      scopes: ["source.java", "meta.array-initializer.java", "keyword.control.new.java"],
    });
    expect(tokens[16]).toEqual({
      value: "A",
      scopes: [
...
`);
    ...
    expect(tokens[8]).toEqual({
      value: "{",
      scopes: ["source.java", "punctuation.section.block.begin.bracket.curly.java"],
    });
    expect(tokens[9]).toEqual({
      value: "new",
      scopes: ["source.java", "keyword.control.new.java"],
    ...
    expect(tokens[11]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.function-call.java", "entity.name.function.java"],
    });
    expect(tokens[12]).toEqual({
      value: "(",
      scopes: [
    ...
    expect(tokens[21]).toEqual({
      value: "}",
      scopes: ["source.java", "punctuation.section.block.end.bracket.curly.java"],
    });
    ...
    expect(tokens[16]).toEqual({
      value: "toString",
      scopes: ["source.java", "meta.method-call.java", "entity.name.function.java"],
    });
    expect(tokens[17]).toEqual({
      value: "(",
      scopes: [
    ...
    expect(tokens[23]).toEqual({
      value: " : ",
      scopes: ["source.java", "string.quoted.double.java"],
    });
    expect(tokens[26]).toEqual({
      value: ":",
      scopes: ["source.java", "keyword.control.ternary.java"],
    });
    expect(tokens[28]).toEqual({
      value: '"',
      scopes: [
    ...
    ({ tokens } = grammar.tokenizeLine(
      "Point point = new Random() ? new Point(1, 4) : new Point(0, 0);",
    ));
    ...
    expect(tokens[2]).toEqual({
      value: "/*",
      scopes: ["source.java", "comment.block.java", "punctuation.definition.comment.java"],
    });
    expect(tokens[4]).toEqual({
      value: "*/",
      scopes: ["source.java", "comment.block.java", "punctuation.definition.comment.java"],
...
`);
    ...
    expect(lines[2][1]).toEqual({
      value: "public",
      scopes: ["source.java", "meta.inner-class.java", "meta.method.java", "storage.modifier.java"],
    });
    expect(lines[4][1]).toEqual({
      value: "int",
      scopes: [
...
`);
  ...
  it("tokenizes the `instanceof` operator", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "instanceof",
      scopes: ["source.java", "keyword.operator.instanceof.java"],
    });
  });
...
`);
    ...
    expect(lines[3][5]).toEqual({
      value: "instanceof",
      scopes: scopeStack.concat(["keyword.operator.instanceof.java"]),
    });
    expect(lines[6][4]).toEqual({
      value: "instanceof",
      scopes: scopeStack.concat([
...
`);
    ...
    expect(lines[1][3]).toEqual({
      value: "String",
      scopes: scopeStack.concat(["meta.definition.variable.java", "storage.type.java"]),
    });
    expect(lines[1][5]).toEqual({
      value: "a",
      scopes: scopeStack.concat([
    ...
    expect(lines[1][7]).toEqual({
      value: "=",
      scopes: scopeStack.concat(["keyword.operator.assignment.java"]),
    });
    expect(lines[1][9]).toEqual({
      value: "func",
      scopes: scopeStack.concat(["meta.function-call.java", "entity.name.function.java"]),
    });
    ...
    expect(lines[2][12]).toEqual({
      value: "a()",
      scopes: scopeStack.concat(["string.quoted.double.java"]),
    });
    expect(lines[2][17]).toEqual({
      value: "a",
      scopes: scopeStack.concat(["meta.function-call.java", "entity.name.function.java"]),
    ...
    expect(lines[2][39]).toEqual({
      value: "a",
      scopes: scopeStack.concat(["meta.function-call.java", "entity.name.function.java"]),
    });
    expect(lines[2][44]).toEqual({ value: " abc ", scopes: scopeStack });
    expect(lines[2][47]).toEqual({
      value: "b",
      scopes: scopeStack.concat(["meta.function-call.java", "entity.name.function.java"]),
    });
    expect(lines[2][54]).toEqual({
      value: "b();",
      scopes: scopeStack.concat(["string.quoted.double.java"]),
    });
    ...
    expect(lines[4][3]).toEqual({
      value: "int",
      scopes: scopeStack.concat(["meta.definition.variable.java", "storage.type.primitive.java"]),
    });
    expect(lines[4][5]).toEqual({
      value: "d",
      scopes: scopeStack.concat([
...
`);
    ...
    expect(lines[2][1]).toEqual({
      value: "try",
      scopes: scopeStack.concat(["keyword.control.try.java"]),
    });
    expect(lines[2][3]).toEqual({
      value: "{",
      scopes: scopeStack.concat(["punctuation.section.try.begin.bracket.curly.java"]),
    });

    scopeStack.push("meta.try.body.java");
    expect(lines[3][1]).toEqual({
      value: "errorProneMethod",
      scopes: scopeStack.concat(["meta.function-call.java", "entity.name.function.java"]),
    });
    ...
    expect(lines[4][1]).toEqual({
      value: "}",
      scopes: scopeStack.concat(["punctuation.section.try.end.bracket.curly.java"]),
    });
    scopeStack.pop();
    scopeStack.push("meta.catch.java");
    expect(lines[4][3]).toEqual({
      value: "catch",
      scopes: scopeStack.concat(["keyword.control.catch.java"]),
    });
    expect(lines[4][5]).toEqual({
      value: "(",
      scopes: scopeStack.concat(["punctuation.definition.parameters.begin.bracket.round.java"]),
    });
    scopeStack.push("meta.catch.parameters.java");
    expect(lines[4][6]).toEqual({
      value: "RuntimeException",
      scopes: scopeStack.concat(["storage.type.java"]),
    });
    expect(lines[4][8]).toEqual({
      value: "re",
      scopes: scopeStack.concat(["variable.parameter.java"]),
    });
    scopeStack.pop();
    expect(lines[4][9]).toEqual({
      value: ")",
      scopes: scopeStack.concat(["punctuation.definition.parameters.end.bracket.round.java"]),
    });
    expect(lines[4][11]).toEqual({
      value: "{",
      scopes: scopeStack.concat(["punctuation.section.catch.begin.bracket.curly.java"]),
    });

    scopeStack.push("meta.catch.body.java");
    expect(lines[5][1]).toEqual({
      value: "handleRuntimeException",
      scopes: scopeStack.concat(["meta.function-call.java", "entity.name.function.java"]),
    });
    ...
    expect(lines[6][1]).toEqual({
      value: "}",
      scopes: scopeStack.concat(["punctuation.section.catch.end.bracket.curly.java"]),
    });
    expect(lines[6][3]).toEqual({
      value: "catch",
      scopes: scopeStack.concat(["keyword.control.catch.java"]),
    ...
    expect(lines[8][3]).toEqual({
      value: "finally",
      scopes: scopeStack.concat(["keyword.control.finally.java"]),
    });
    expect(lines[8][5]).toEqual({
      value: "{",
      scopes: scopeStack.concat(["punctuation.section.finally.begin.bracket.curly.java"]),
    });
    ...
    expect(lines[10][1]).toEqual({
      value: "new",
      scopes: scopeStack.concat(["keyword.control.new.java"]),
    });

    scopeStack.pop();
    expect(lines[11][1]).toEqual({
      value: "}",
      scopes: scopeStack.concat(["punctuation.section.finally.end.bracket.curly.java"]),
    });
  });
...
`);
    ...
    expect(lines[2][1]).toEqual({
      value: "try",
      scopes: scopes.concat(["keyword.control.try.java"]),
    });
    ...
    expect(lines[5][3]).toEqual({
      value: "{",
      scopes: scopes.concat(["punctuation.section.try.begin.bracket.curly.java"]),
    });
  });
...
`);
    ...
    expect(lines[5][8]).toEqual({
      ...
      scopes: [
        ...
        "meta.catch.java",
        "meta.catch.parameters.java",
        "punctuation.catch.separator.java",
      ],
    });
    expect(lines[5][10]).toEqual({
      value: "Exception2",
...
`);
    ...
    expect(lines[0][0]).toEqual({
      value: "/**",
      scopes: ["source.java", "comment.block.javadoc.java", "punctuation.definition.comment.java"],
    });
    expect(lines[0][1]).toEqual({
      value: " single-line javadoc comment ",
      scopes: ["source.java", "comment.block.javadoc.java"],
    });
    expect(lines[0][2]).toEqual({
      value: "*/",
      scopes: ["source.java", "comment.block.javadoc.java", "punctuation.definition.comment.java"],
...
`);
    ...
    expect(lines[1][2]).toEqual({
      value: " javadoc comment ",
      scopes: ["source.java", "meta.enum.java", "comment.block.javadoc.java"],
    });
    expect(lines[1][3]).toEqual({
      value: "*/",
      scopes: [
...
`);
    ...
    expect(lines[0][0]).toEqual({
      value: "/**/",
      scopes: ["source.java", "comment.block.empty.java", "punctuation.definition.comment.java"],
    });
    expect(lines[0][2]).toEqual({
      value: "int",
      scopes: ["source.java", "meta.definition.variable.java", "storage.type.primitive.java"],
...
`);
    ...
    expect(lines[0][1]).toEqual({
      value: "Annotation",
      scopes: ["source.java", "meta.declaration.annotation.java", "storage.type.annotation.java"],
    });
    ...
    expect(lines[1][3]).toEqual({
      value: "key",
      scopes: ["source.java", "meta.declaration.annotation.java", "constant.other.key.java"],
    });
    expect(lines[1][5]).toEqual({
      value: "=",
      scopes: [
    ...
    expect(lines[1][8]).toEqual({
      value: "value",
      scopes: ["source.java", "meta.declaration.annotation.java", "string.quoted.double.java"],
    });
    expect(lines[1][9]).toEqual({
      value: '"',
      scopes: [
    ...
    expect(lines[6][2]).toEqual({
      value: "interface",
      scopes: ["source.java", "meta.declaration.annotation.java", "storage.modifier.java"],
    });
    expect(lines[6][4]).toEqual({
      value: "Test",
      scopes: ["source.java", "meta.declaration.annotation.java", "storage.type.annotation.java"],
...
`);
    ...
    expect(lines[1][1]).toEqual({
      value: "@",
      scopes: scopes.concat(["punctuation.definition.annotation.java"]),
    });
    expect(lines[1][3]).toEqual({
      value: "Override",
      scopes: scopes.concat(["storage.type.annotation.java"]),
    });
    expect(lines[5][1]).toEqual({
      value: "@",
      scopes: scopes.concat(["punctuation.definition.annotation.java"]),
    ...
    expect(lines[5][6]).toEqual({
      value: "message",
      scopes: scopes.concat(["string.quoted.double.java"]),
    });
  });
...
`);
    ...
    expect(lines[1][4]).toEqual({
      value: "interface",
      scopes: scopes.concat(["meta.declaration.annotation.java", "storage.modifier.java"]),
    });
    expect(lines[2][1]).toEqual({
      value: "//",
      scopes: scopes.concat([
    ...
    expect(lines[3][5]).toEqual({
      value: "func",
      scopes: scopes.concat(["meta.function-call.java", "entity.name.function.java"]),
    });
  });
...
`);
    ...
    expect(lines[0][0]).toEqual({
      value: "record",
      scopes: recordScopes.concat(["meta.record.identifier.java", "storage.modifier.java"]),
    });
    expect(lines[0][2]).toEqual({
      value: "Point",
      scopes: recordScopes.concat(["meta.record.identifier.java", "entity.name.type.record.java"]),
    });
    expect(lines[0][3]).toEqual({
      value: "(",
      scopes: recordScopes.concat([
    ...
    expect(lines[0][7]).toEqual({
      value: "}",
      scopes: recordScopes.concat(["punctuation.section.class.end.bracket.curly.java"]),
    });
  });
...
`);
    ...
    expect(lines[0][0]).toEqual({
      value: "public",
      scopes: recordScopes.concat(["storage.modifier.java"]),
    });
    expect(lines[0][2]).toEqual({
      value: "record",
      scopes: recordScopes.concat(["meta.record.identifier.java", "storage.modifier.java"]),
    ...
    expect(lines[0][6]).toEqual({
      value: "int",
      scopes: recordScopes.concat(["meta.record.identifier.java", "storage.type.primitive.java"]),
    });
    expect(lines[0][8]).toEqual({
      value: ")",
      scopes: recordScopes.concat([
...
`);
    ...
    expect(lines[0][6]).toEqual({
      value: "T",
      scopes: recordScopes.concat(["meta.record.identifier.java", "storage.type.generic.java"]),
    });
    expect(lines[0][7]).toEqual({
      value: ">",
      scopes: recordScopes.concat([
    ...
    expect(lines[0][9]).toEqual({
      value: "T",
      scopes: recordScopes.concat(["meta.record.identifier.java", "storage.type.java"]),
    });
...
`);
    ...
    expect(lines[1][1]).toEqual({
      value: "public",
      scopes: methodScopes.concat(["storage.modifier.java"]),
    });
    expect(lines[1][3]).toEqual({
      value: "Point",
      scopes: methodScopes.concat(["meta.method.identifier.java", "entity.name.function.java"]),
    });
    expect(lines[1][5]).toEqual({
      value: "{",
      scopes: methodScopes.concat(["punctuation.section.method.begin.bracket.curly.java"]),
    });
    expect(lines[2][1]).toEqual({
      value: "//",
      scopes: methodScopes.concat([
        "meta.method.body.java",
        "comment.line.double-slash.java",
        "punctuation.definition.comment.java",
      ]),
    ...
    expect(lines[3][1]).toEqual({
      value: "}",
      scopes: methodScopes.concat(["punctuation.section.method.end.bracket.curly.java"]),
    });
    expect(lines[4][1]).toEqual({
      value: "private",
      scopes: methodScopes.concat(["storage.modifier.java"]),
    ...
    expect(lines[4][3]).toEqual({
      value: "void",
      scopes: methodScopes.concat(["meta.method.return-type.java", "storage.type.primitive.java"]),
    });
    expect(lines[4][5]).toEqual({
      value: "foo",
      scopes: methodScopes.concat(["meta.method.identifier.java", "entity.name.function.java"]),
...
`);
    ...
    expect(lines[1][1]).toEqual({
      value: "record",
      scopes: scopes.concat(["meta.record.identifier.java", "storage.modifier.java"]),
    });
    expect(lines[1][3]).toEqual({
      value: "Point",
      scopes: scopes.concat(["meta.record.identifier.java", "entity.name.type.record.java"]),
    });
    expect(lines[1][4]).toEqual({
      value: "(",
      scopes: scopes.concat([
    ...
    expect(lines[1][8]).toEqual({
      value: "}",
      scopes: scopes.concat(["punctuation.section.class.end.bracket.curly.java"]),
    });
  });
...
`);
    ...
    expect(lines[4][1]).toEqual({
      value: "yield",
      scopes: ["source.java", "keyword.control.java"],
    });
  });
...
`);
    ...
    expect(lines[0][2]).toEqual({
      value: "sealed",
      scopes: ["source.java", "meta.class.java", "storage.modifier.java"],
    });
    expect(lines[0][16]).toEqual({
      value: "permits",
      scopes: [
        "source.java",
        "meta.class.java",
        "meta.definition.class.permits.classes.java",
