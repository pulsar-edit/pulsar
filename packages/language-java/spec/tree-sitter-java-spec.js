...
xdescribe("Tree-sitter based Java grammar", function () {
    ...
    while (true) {
      ...
      if (end.column > start.column) {
        tokens.push({
          ...
          scopes: Array.from(scopes).map((s) =>
            buffer.getLanguageMode().grammar.scopeNameForScopeId(s),
          ),
        });
      }
  ...
  it("tokenizes punctuation", function () {
    ...
    expect(tokens[2]).toEqual({
      value: ",",
      scopes: ["source.java", "punctuation.separator.delimiter"],
    });
    ...
    expect(tokens[6]).toEqual({
      value: ";",
      scopes: ["source.java", "punctuation.terminator.statement"],
    });
    ...
    expect(tokens[1]).toEqual({
      value: ".",
      scopes: ["source.java", "punctuation.separator.period"],
    });
...
`);
    ...
    expect(tokens[0][1]).toEqual({
      value: ">",
      scopes: ["source.java", "keyword.operator.comparison"],
    });
...
`);
    ...
    expect(tokens[0][1]).toEqual({
      value: "&&",
      scopes: ["source.java", "keyword.operator.logical"],
    });
    expect(tokens[1][1]).toEqual({
      value: "||",
      scopes: ["source.java", "keyword.operator.logical"],
...
`);
    ...
    expect(tokens[0][1]).toEqual({
      value: "+",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    });
    expect(tokens[1][1]).toEqual({
      value: "-",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    ...
    expect(tokens[7][1]).toEqual({
      value: "*=",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    });
    expect(tokens[8][1]).toEqual({
      value: "/=",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    });
    expect(tokens[9][1]).toEqual({
      value: "%=",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    });
    expect(tokens[10][1]).toEqual({
      value: "++",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    });
    expect(tokens[11][0]).toEqual({
      value: "--",
      scopes: ["source.java", "keyword.operator.arithmetic"],
    });
  });
...
`);
    ...
    expect(tokens[0][1]).toEqual({
      value: "&",
      scopes: ["source.java", "keyword.operator.bitwise"],
    });
    expect(tokens[1][1]).toEqual({
      value: "|",
      scopes: ["source.java", "keyword.operator.bitwise"],
    ...
    expect(tokens[11][1]).toEqual({
      value: ">>>=",
      scopes: ["source.java", "keyword.operator.bitwise"],
    });
    expect(tokens[12][0]).toEqual({
      value: "~",
      scopes: ["source.java", "keyword.operator.bitwise"],
    });
  });
  ...
  it("tokenizes brackets", function () {
    ...
    expect(tokens[10]).toEqual({
      value: "[",
      scopes: ["source.java", "punctuation.bracket.square"],
    });
    ...
    expect(tokens[14]).toEqual({
      value: "}",
      scopes: ["source.java", "punctuation.bracket.curly"],
    });
  });
...
`);
    ...
    expect(tokens[0][3]).toEqual({
      value: "null",
      scopes: ["source.java", "constant.language.null"],
    });
...
`);
    ...
    expect(tokens[0][2]).toEqual({
      value: "CONSTANT_STR",
      scopes: ["source.java", "constant.other"],
    });
...
`);
  ...
  it("tokenizes packages", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "package",
      scopes: ["source.java", "meta.package", "keyword.other.package"],
    });
    expect(tokens[1]).toEqual({ value: " com", scopes: ["source.java", "meta.package"] });
    expect(tokens[2]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.package", "punctuation.separator.period"],
    });
    expect(tokens[3]).toEqual({ value: "test", scopes: ["source.java", "meta.package"] });
    expect(tokens[4]).toEqual({
      value: ";",
      scopes: ["source.java", "meta.package", "punctuation.terminator.statement"],
    });
  });
  ...
  it("tokenizes imports", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "import",
      scopes: ["source.java", "meta.import", "keyword.other.import"],
    });
  });
  ...
  it("tokenizes static imports", function () {
    ...
    expect(tokens[2]).toEqual({
      value: "static",
      scopes: ["source.java", "meta.import", "keyword.other.static"],
    });
  });
  ...
  it("tokenizes imports with asterisk", function () {
    ...
    expect(tokens[7]).toEqual({
      value: "*",
      scopes: ["source.java", "meta.import", "variable.language.wildcard"],
    });
  });
...
`);
    ...
    expect(tokens[1][3]).toEqual({
      value: "static",
      scopes: ["source.java", "meta.class.body", "storage.modifier"],
    });
    expect(tokens[3][1]).toEqual({
      value: "static",
      scopes: ["source.java", "meta.class.body", "storage.modifier"],
...
`);
    ...
    expect(tokens[0][2]).toEqual({
      value: "instanceof",
      scopes: ["source.java", "keyword.operator.instanceof"],
    });
    ...
    expect(tokens[4][4]).toEqual({
      value: "instanceof",
      scopes: ["source.java", "keyword.operator.instanceof"],
    });
    expect(tokens[5][4]).toEqual({
      value: "instanceof",
      scopes: ["source.java", "keyword.operator.instanceof"],
    });
  });
...
`);
  ...
  it("tokenizes lambda expressions", function () {
    ...
    expect(tokens[5]).toEqual({
      value: "->",
      scopes: ["source.java", "storage.type.function.arrow"],
    });
  });
  ...
  it("tokenizes spread parameters", function () {
    ...
    expect(tokens[6]).toEqual({
      value: "...",
      scopes: ["source.java", "punctuation.definition.parameters.varargs"],
    });
...
`);
    ...
    expect(tokens[0][2]).toEqual({
      value: "A$B",
      scopes: ["source.java", "entity.name.type.class"],
    });
    expect(tokens[0][3]).toEqual({ value: " ", scopes: ["source.java"] });
    expect(tokens[0][4]).toEqual({
      value: "{",
      scopes: ["source.java", "meta.class.body", "punctuation.bracket.curly"],
    });
    expect(tokens[1][3]).toEqual({
      value: "func$",
      scopes: ["source.java", "meta.class.body", "meta.method", "entity.name.function"],
    });
    expect(tokens[2][1]).toEqual({
      value: "$object",
      scopes: ["source.java", "meta.class.body", "meta.method", "meta.method.body"],
    });
...
`);
    ...
    expect(tokens[1][1]).toEqual({
      value: "void",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[2][1]).toEqual({
      value: "boolean",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    ...
    expect(tokens[9][3]).toEqual({
      value: "util",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[9][5]).toEqual({
      value: "List",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[9][7]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
  });
...
`);
    ...
    expect(tokens[2][4]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.class.body", "meta.method", "meta.method.body", "storage.type"],
    });
...
`);
    ...
    expect(tokens[0][3]).toEqual({
      value: "<",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
    ...
    expect(tokens[1][6]).toEqual({
      value: "extends",
      scopes: ["source.java", "storage.modifier.extends"],
    });
    ...
    expect(tokens[2][10]).toEqual({
      value: "&",
      scopes: ["source.java", "punctuation.separator.types"],
    });
    ...
    expect(tokens[4][7]).toEqual({
      value: "extends",
      scopes: ["source.java", "storage.modifier.extends"],
    });
    expect(tokens[4][9]).toEqual({ value: "A", scopes: ["source.java", "storage.type"] });
    expect(tokens[4][10]).toEqual({
      value: "<",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
    expect(tokens[4][11]).toEqual({
      value: "?",
      scopes: ["source.java", "storage.type.generic.wildcard"],
    });
    expect(tokens[4][13]).toEqual({
      value: "extends",
      scopes: ["source.java", "storage.modifier.extends"],
    });
    expect(tokens[4][15]).toEqual({ value: "D", scopes: ["source.java", "storage.type"] });
    expect(tokens[4][16]).toEqual({
      value: ">",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
    expect(tokens[4][18]).toEqual({
      value: "&",
      scopes: ["source.java", "punctuation.separator.types"],
    });
    expect(tokens[4][20]).toEqual({ value: "B", scopes: ["source.java", "storage.type"] });
    expect(tokens[4][21]).toEqual({
      value: ">",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
    ...
    expect(tokens[5][5]).toEqual({
      value: ",",
      scopes: ["source.java", "punctuation.separator.delimiter"],
    });
    expect(tokens[5][7]).toEqual({ value: "S", scopes: ["source.java", "storage.type"] });
    expect(tokens[5][8]).toEqual({
      value: ">",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
    expect(tokens[5][10]).toEqual({
      value: "extends",
      scopes: ["source.java", "storage.modifier.extends"],
    });
    expect(tokens[5][12]).toEqual({ value: "Common", scopes: ["source.java", "storage.type"] });
    expect(tokens[5][13]).toEqual({
      value: "<",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
    expect(tokens[5][14]).toEqual({
      value: "?",
      scopes: ["source.java", "storage.type.generic.wildcard"],
    });
    expect(tokens[5][16]).toEqual({
      value: "super",
      scopes: ["source.java", "storage.modifier.super"],
    });
    expect(tokens[5][18]).toEqual({ value: "T", scopes: ["source.java", "storage.type"] });
    expect(tokens[5][19]).toEqual({
      value: ">",
      scopes: ["source.java", "punctuation.bracket.angle"],
    });
...
`);
    ...
    expect(tokens[1][1]).toEqual({
      value: "HashMap",
      scopes: ["source.java", "meta.class.body", "storage.type"],
    });
    expect(tokens[1][2]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "punctuation.bracket.angle"],
    });
    expect(tokens[1][3]).toEqual({
      value: "Integer",
      scopes: ["source.java", "meta.class.body", "storage.type"],
    ...
    expect(tokens[1][4]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.body", "punctuation.separator.delimiter"],
    });
    expect(tokens[1][6]).toEqual({
      value: "String",
      scopes: ["source.java", "meta.class.body", "storage.type"],
    ...
    expect(tokens[2][6]).toEqual({
      value: "?",
      scopes: ["source.java", "meta.class.body", "storage.type.generic.wildcard"],
    });
    expect(tokens[2][8]).toEqual({
      value: "extends",
      scopes: ["source.java", "meta.class.body", "storage.modifier.extends"],
    });
    expect(tokens[2][10]).toEqual({
      value: "ArrayList",
      scopes: ["source.java", "meta.class.body", "storage.type"],
    ...
    expect(tokens[3][3]).toEqual({
      value: "Map",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "storage.type"],
    });
    expect(tokens[3][4]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "punctuation.bracket.angle"],
    });
    expect(tokens[3][5]).toEqual({
      value: "?",
      scopes: [
    ...
    expect(tokens[3][10]).toEqual({
      value: "extends",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "storage.modifier.extends"],
    });
    expect(tokens[3][12]).toEqual({
      value: "List",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "storage.type"],
    ...
    expect(tokens[4][2]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[4][3]).toEqual({
      value: "Integer",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    ...
    expect(tokens[4][4]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.delimiter"],
    });
    ...
    expect(tokens[5][4]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "punctuation.separator.period"],
    });
    expect(tokens[5][5]).toEqual({
      value: "Entry",
      scopes: ["source.java", "meta.class.body", "storage.type"],
    });
    expect(tokens[5][6]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "punctuation.bracket.angle"],
    });
    ...
    expect(tokens[5][11]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "punctuation.bracket.angle"],
    });
    expect(tokens[5][12]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "punctuation.bracket.angle"],
    });
    ...
    expect(tokens[6][8]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "punctuation.bracket.angle"],
    });
    expect(tokens[6][9]).toEqual({
      value: "K",
      scopes: ["source.java", "meta.class.body", "storage.type"],
    });
    expect(tokens[6][10]).toEqual({
    ...
    expect(tokens[8][2]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[8][3]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[8][4]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.delimiter"],
    });
    expect(tokens[8][6]).toEqual({
      value: "B",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[8][7]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.delimiter"],
    });
    expect(tokens[8][9]).toEqual({
      value: "C",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[8][10]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    ...
    expect(tokens[9][2]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[9][3]).toEqual({
      value: "util",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[9][4]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[9][5]).toEqual({
    ...
    expect(tokens[11][2]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[11][3]).toEqual({
      value: "util",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][4]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[11][5]).toEqual({
      value: "List",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][6]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[11][7]).toEqual({
      value: "java",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][8]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[11][9]).toEqual({
      value: "util",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][10]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[11][11]).toEqual({
      value: "Map",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][12]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[11][13]).toEqual({
      value: "Integer",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][14]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.delimiter"],
    });
    expect(tokens[11][16]).toEqual({
      value: "java",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][17]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[11][18]).toEqual({
      value: "lang",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][19]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[11][20]).toEqual({
      value: "String",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[11][21]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[11][22]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });

    expect(tokens[12][1]).toEqual({
      value: "java",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[12][2]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[12][3]).toEqual({
    ...
    expect(tokens[12][4]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[12][5]).toEqual({
      value: "List",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[12][6]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[12][7]).toEqual({
      value: "?",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type.generic.wildcard"],
    });
    expect(tokens[12][9]).toEqual({
      value: "extends",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.modifier.extends"],
    });
    expect(tokens[12][11]).toEqual({
      value: "Integer",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[12][12]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });

    expect(tokens[13][1]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[13][2]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[13][4]).toEqual({
      value: "extends",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.modifier.extends"],
    });
    expect(tokens[13][6]).toEqual({
      value: "Integer",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[13][7]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[13][9]).toEqual({
      value: "java",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[13][10]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[13][11]).toEqual({
      value: "util",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[13][12]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.period"],
    });
    expect(tokens[13][13]).toEqual({
      value: "List",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[13][14]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[13][15]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[13][16]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });

    expect(tokens[14][1]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[14][2]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[14][4]).toEqual({
      value: "extends",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.modifier.extends"],
    });
    expect(tokens[14][6]).toEqual({
      value: "Annotation",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[14][7]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[14][9]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[14][14]).toEqual({
      value: "<",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
    expect(tokens[14][15]).toEqual({
      value: "T",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[14][16]).toEqual({
      value: ">",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.angle"],
    });
  });
...
`);
    ...
    expect(tokens[10][6]).toEqual({
      value: "ArrayList",
      scopes: ["source.java", "meta.class.body", "meta.method", "meta.method.body", "storage.type"],
    });
    expect(tokens[10][7]).toEqual({
      value: "<",
      scopes: [
        "source.java",
        "meta.class.body",
    ...
    expect(tokens[10][8]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.class.body", "meta.method", "meta.method.body", "storage.type"],
    });
    expect(tokens[10][9]).toEqual({
      value: ">",
      scopes: [
        "source.java",
        "meta.class.body",
...
`);
  ...
  it("tokenizes classes", function () {
    ...
    expect(tokens[8]).toEqual({
      value: "implements",
      scopes: ["source.java", "storage.modifier.implements"],
    });
  ...
  it("tokenizes interfaces", function () {
    ...
    expect(tokens[2]).toEqual({
      value: "interface",
      scopes: ["source.java", "keyword.other.interface"],
    });
    expect(tokens[4]).toEqual({
      value: "A",
      scopes: ["source.java", "entity.name.type.interface"],
    });
    expect(tokens[6]).toEqual({
      value: "{",
      scopes: ["source.java", "meta.interface.body", "punctuation.bracket.curly"],
    });
    expect(tokens[8]).toEqual({
      value: "}",
      scopes: ["source.java", "meta.interface.body", "punctuation.bracket.curly"],
...
`);
    ...
    expect(tokens[0][2]).toEqual({
      value: "@interface",
      scopes: ["source.java", "keyword.other.interface.annotated"],
    });
    expect(tokens[0][4]).toEqual({
      value: "A",
      scopes: ["source.java", "entity.name.type.interface.annotated"],
    });
    expect(tokens[0][6]).toEqual({
      value: "{",
      scopes: ["source.java", "meta.interface.annotated.body", "punctuation.bracket.curly"],
    });
    expect(tokens[1][1]).toEqual({
      value: "String",
      scopes: ["source.java", "meta.interface.annotated.body", "storage.type"],
    });
    expect(tokens[1][3]).toEqual({
      value: "method",
      scopes: ["source.java", "meta.interface.annotated.body", "entity.name.function"],
    });
    expect(tokens[1][7]).toEqual({
      value: "default",
...
`);
    ...
    expect(tokens[0][10]).toEqual({
      value: "{",
      scopes: ["source.java", "meta.enum.body", "punctuation.bracket.curly"],
    });
    expect(tokens[1][1]).toEqual({
      value: "CONSTANT1",
      scopes: ["source.java", "meta.enum.body", "constant.other.enum"],
    });
    expect(tokens[2][1]).toEqual({
      value: "CONSTANT2",
      scopes: ["source.java", "meta.enum.body", "constant.other.enum"],
...
`);
    ...
    expect(tokens[0][4]).toEqual({
      value: "Test",
      scopes: ["source.java", "entity.name.type.enum"],
    });
    ...
    expect(tokens[2][0]).toEqual({
      value: "protected",
      scopes: ["source.java", "storage.modifier"],
    });
...
`);
    ...
    expect(tokens[0][0]).toEqual({
      value: "@",
      scopes: ["source.java", "meta.declaration.annotation", "punctuation.definition.annotation"],
    });
    expect(tokens[0][1]).toEqual({
      value: "Annotation1",
      scopes: ["source.java", "meta.declaration.annotation", "storage.type.annotation"],
    });
    ...
    expect(tokens[3][3]).toEqual({
      value: "key",
      scopes: ["source.java", "meta.declaration.annotation", "variable.other.annotation.element"],
    });
    expect(tokens[3][5]).toEqual({
      value: "=",
    ...
    expect(tokens[4][2]).toEqual({
      value: ".",
      scopes: ["source.java", "meta.declaration.annotation", "punctuation.separator.period"],
    });
    expect(tokens[4][3]).toEqual({
      value: "Annotation5",
      scopes: ["source.java", "meta.declaration.annotation", "storage.type.annotation"],
...
`);
    ...
    expect(tokens[1][1]).toEqual({
      value: "public",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "storage.modifier"],
    });
    expect(tokens[1][3]).toEqual({
      value: "A",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "entity.name.function"],
    });
    expect(tokens[1][4]).toEqual({
      value: "(",
      scopes: ["source.java", "meta.class.body", "meta.constructor", "punctuation.bracket.round"],
    });
...
`);
    ...
    expect(tokens[1][1]).toEqual({
      value: "public",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.modifier"],
    });
    expect(tokens[1][3]).toEqual({
      value: "int",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    ...
    expect(tokens[1][4]).toEqual({
      value: "[",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.square"],
    });
    expect(tokens[1][5]).toEqual({
      value: "]",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.square"],
    ...
    expect(tokens[1][8]).toEqual({
      value: "(",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.round"],
    });
    expect(tokens[1][9]).toEqual({
      value: "int",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    ...
    expect(tokens[9][9]).toEqual({
      value: "int",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[9][11]).toEqual({
      value: ",",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.separator.delimiter"],
    });
    expect(tokens[9][13]).toEqual({
      value: "final",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.modifier"],
    });
    expect(tokens[9][15]).toEqual({
      value: "int",
      scopes: ["source.java", "meta.class.body", "meta.method", "storage.type"],
    });
    expect(tokens[9][17]).toEqual({
      value: ")",
      scopes: ["source.java", "meta.class.body", "meta.method", "punctuation.bracket.round"],
    });
    expect(tokens[9][19]).toEqual({
      value: "{",
      scopes: [
        "source.java",
        "meta.class.body",
