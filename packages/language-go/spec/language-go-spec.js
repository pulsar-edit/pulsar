describe("Go settings", function () {
  ...
  it("matches lines correctly using the decreaseNextIndentPattern", function () {
    const decreaseNextIndentRegex = languageMode.decreaseNextIndentRegexForScopeDescriptor([
      "source.go",
    ]);
    ...
    expect(decreaseNextIndentRegex.findNextMatchSync('  fmt.Println("something")),')).toBeTruthy();
    expect(
      decreaseNextIndentRegex.findNextMatchSync('  fmt.Println("something"), "x"),'),
    ).toBeTruthy();
    expect(
      decreaseNextIndentRegex.findNextMatchSync('  fmt.Println(fmt.Sprint("something"))),'),
    ).toBeTruthy();
    expect(
      decreaseNextIndentRegex.findNextMatchSync('  fmt.Println(fmt.Sprint("something"), "x")),'),
    ).toBeTruthy();
