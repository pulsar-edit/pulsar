...
module.exports = class BackgroundTipsElement {
  constructor() {
    ...
    this.disposables.add(
      new Disposable(() => atom.getCurrentWindow().removeListener("blur", visibilityCallback)),
    );
    this.disposables.add(
      new Disposable(() => atom.getCurrentWindow().removeListener("focus", visibilityCallback)),
    );
