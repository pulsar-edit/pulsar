...
module.exports = class ProjectFindView {
  ...
  render() {
    return $.div(
      { tabIndex: -1, className: "project-find padded" },
      $.header(
        { className: "header" },
        $.span(
        ...
        $.span(
          ...
          $.span(
            ...
            $.button(
              ...
              $.svg({
                className: "icon",
                innerHTML: `<use xlink:href="#find-and-replace-icon-regex" />`,
              }),
            ),
            $.button(
              { ref: "caseOptionButton", className: "btn option-case-sensitive" },
              $.svg({
                className: "icon",
                innerHTML: `<use xlink:href="#find-and-replace-icon-case" />`,
              }),
            ),
            $.button(
              ...
              $.svg({
                className: "icon",
                innerHTML: `<use xlink:href="#find-and-replace-icon-word" />`,
              }),
            ),
          ),
        ),
    ...
    this.subscriptions.add(
      atom.commands.add("atom-workspace", {
        ...
        "find-and-replace:use-selection-as-replace-pattern": () =>
          this.setSelectionAsReplacePattern(),
      }),
    );
