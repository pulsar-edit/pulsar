...
module.exports = {
  activate(param) {
    ...
    this.subscriptions.add(
      atom.commands.add(".find-and-replace, .project-find", "window:focus-next-pane", () =>
    ...
    this.subscriptions.add(
      atom.commands.add("atom-workspace", "find-and-replace:use-selection-as-find-pattern", () => {
    ...
    this.subscriptions.add(
      atom.commands.add("atom-workspace", "find-and-replace:show-replace", () => {
        this.createViews();
        return showPanel(this.findPanel, this.projectFindPanel, () =>
    ...
    this.subscriptions.add(
      atom.commands.add("atom-workspace", "find-and-replace:clear-history", () => {
