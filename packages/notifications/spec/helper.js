    ...
    generateFakeFetchResponses: function(options) {
      ...
      return fetch.andCallFake(function(url) {
        ...
        if (url.indexOf('api.pulsar-edit.dev/api') > -1) {
          return jsonPromise((ref = options != null ? options.packageResponse : void 0) != null ? ref : {
            repository: {
        ...
        return jsonPromise((ref1 = options != null ? options.issuesResponse : void 0) != null ? ref1 : {
          items: []
        });
      });
    }
