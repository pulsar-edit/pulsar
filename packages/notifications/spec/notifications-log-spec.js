...
(function() {
  var Notification, NotificationElement, NotificationIssue, NotificationsLog, generateException, generateFakeFetchResponses, ref;
  ...
  describe("Notifications Log", function() {
    ...
    return describe("the dock pane", function() {
      ...
      beforeEach(function() {
        return notificationsLogPane = atom.workspace.paneForURI(NotificationsLog.prototype.getURI());
      });
      return describe("when notifications:toggle-log is dispatched", function() {
        ...
        describe("when the pane is destroyed", function() {
          ...
          it("opens the pane", function() {
            ...
            notificationsLog = [][0];
            waitsForPromise(function() {
              return atom.workspace.toggle(NotificationsLog.prototype.getURI()).then(function(paneItem) {
