describe("Less grammar", () => {
  ...
  it("parses color names", () => {
    const { tokens } = grammar.tokenizeLine(
      ".foo { color: rebeccapurple; background: whitesmoke; }",
    );
  ...
  it("parses property names distinctly from property values with the same text", () => {
    ...
    expect(tokens[2]).toEqual({
      value: ":",
      scopes: ["source.css.less", "meta.property-list.css", "punctuation.separator.key-value.css"],
    });
    ...
    expect(tokens[5]).toEqual({
      value: ";",
      scopes: ["source.css.less", "meta.property-list.css", "punctuation.terminator.rule.css"],
    });
  ...
  it("parses @media features", () => {
    ...
    expect(tokens[1]).toEqual({
      value: "media",
      scopes: ["source.css.less", "meta.at-rule.media.css", "keyword.control.at-rule.media.css"],
    });
    expect(tokens[4]).toEqual({
      value: "min-width",
      scopes: ["source.css.less", "support.type.property-name.media.css"],
    });
    ...
    expect(tokens[8]).toEqual({
      value: "px",
      scopes: ["source.css.less", "constant.numeric.css", "keyword.other.unit.px.css"],
    });
  });
  ...
  it("parses @media orientation", () => {
    ...
    expect(tokens[7]).toEqual({
      value: "portrait",
      scopes: ["source.css.less", "support.constant.property-value.media-property.media.css"],
    });
  });
  ...
  it("parses parent selector", () => {
    ...
    expect(tokens[2]).toEqual({
      value: "hover",
      scopes: ["source.css.less", "entity.other.attribute-name.pseudo-class.css"],
    });
  ...
  it("parses pseudo element", () => {
    ...
    expect(tokens[3]).toEqual({
      value: "after",
      scopes: ["source.css.less", "entity.other.attribute-name.pseudo-element.css"],
    });
    expect(tokens[4]).toEqual({ value: " ", scopes: ["source.css.less"] });
    expect(tokens[5]).toEqual({
      value: "{",
  ...
  it("parses custom selectors", () => {
    ...
    expect(tokens[0]).toEqual({
      value: "abc-123-xyz",
      scopes: ["source.css.less", "entity.name.tag.custom.css"],
    });
  });

  it("parses pseudo classes", () => {
    const { tokens } = grammar.tokenizeLine(
      ".foo:hover { span:last-of-type { font-weight: bold; } }",
    );
    expect(tokens[0]).toEqual({
      value: ".",
      scopes: [
    ...
    expect(tokens[7]).toEqual({
      value: "span",
      scopes: ["source.css.less", "meta.property-list.css", "entity.name.tag.css"],
    });
    expect(tokens[8]).toEqual({
      value: ":",
      scopes: [
    ...
    expect(tokens[12]).toEqual({
      value: " ",
      scopes: ["source.css.less", "meta.property-list.css", "meta.property-list.css"],
    });
...
`);
    ...
    expect(lines[0][7]).toEqual({
      value: ",",
      scopes: ["source.css.less", "meta.property-list.css", "punctuation.separator.list.comma.css"],
    });
...
`);
  ...
  it("parses css variables", () => {
    ...
    expect(tokens[6]).toEqual({
      value: "spacing-unit",
      scopes: ["source.css.less", "meta.property-list.css", "variable.other.less"],
    });
    expect(tokens[7]).toEqual({
      value: ":",
      scopes: ["source.css.less", "meta.property-list.css", "punctuation.separator.key-value.css"],
  ...
  it("parses variable interpolation in properties", () => {
    ...
    expect(tokens[5]).toEqual({
      value: "@{property}",
      scopes: ["source.css.less", "meta.property-list.css", "variable.other.interpolation.less"],
    });
    expect(tokens[6]).toEqual({
      value: ":",
      scopes: ["source.css.less", "meta.property-list.css", "punctuation.separator.key-value.css"],
  ...
  it("parses variable interpolation in urls", () => {
    const { tokens } = grammar.tokenizeLine(
      '.foo { background: #F0F0F0 url("@{var}/img.png"); }";',
    );
    expect(tokens[8]).toEqual({
      value: "#F0F0F0",
      scopes: [
    ...
    expect(tokens[10]).toEqual({
      ...
      scopes: [
        ...
        "meta.property-list.css",
        "meta.property-value.css",
        "support.function.any-method.builtin.url.css",
      ],
    });
    expect(tokens[11]).toEqual({
      value: "(",
  ...
  it("parses variable interpolation in imports", () => {
    ...
    expect(tokens[1]).toEqual({
      value: "import",
      scopes: ["source.css.less", "meta.at-rule.import.css", "keyword.control.at-rule.import.less"],
    });
    expect(tokens[2]).toEqual({
      value: " ",
      scopes: ["source.css.less", "meta.at-rule.import.css"],
    });
    expect(tokens[3]).toEqual({
      value: '"',
      scopes: [
  ...
  it("parses options in import statements", () => {
    ...
    expect(tokens[4]).toEqual({
      value: "optional",
      scopes: ["source.css.less", "meta.at-rule.import.css", "keyword.control.import.option.less"],
    });
    expect(tokens[5]).toEqual({
      value: ",",
      scopes: [
    ...
    expect(tokens[11]).toEqual({
      value: "theme",
      scopes: ["source.css.less", "meta.at-rule.import.css", "string.quoted.double.css"],
    });
  });
  ...
  it("parses non-quoted urls followed by a format", () => {
    const { tokens } = grammar.tokenizeLine(
      '@font-face { src: url(http://example.com/font.woff) format("woff"); }',
    );
    expect(tokens[8]).toEqual({
      value: "url",
      scopes: [
    ...
    expect(tokens[10]).toEqual({
      value: "http://example.com/font.woff",
      scopes: [
        "source.css.less",
        "meta.property-list.css",
        "meta.property-value.css",
  ...
  it('parses the "true" value', () => {
    ...
    expect(tokens[4]).toEqual({
      value: "true",
      scopes: ["source.css.less", "constant.language.boolean.less"],
    });
  });

  it("parses mixin guards", () => {
    const { tokens } = grammar.tokenizeLine(
      ".mixin() when (isnumber(@b)) and (default()), (ispixel(@a)) and  not (@a < 0) { }",
    );
    expect(tokens[4]).toEqual({
      value: "when",
      scopes: ["source.css.less", "keyword.control.logical.operator.less"],
    });
    expect(tokens[7]).toEqual({
      value: "isnumber",
      scopes: ["source.css.less", "support.function.type-checking.less"],
    });
    expect(tokens[14]).toEqual({
      value: "and",
      scopes: ["source.css.less", "keyword.control.logical.operator.less"],
    ...
    expect(tokens[17]).toEqual({
      value: "default",
      scopes: ["source.css.less", "support.function.default.less"],
    });
    expect(tokens[21]).toEqual({
      value: ",",
      scopes: ["source.css.less", "punctuation.separator.list.comma.css"],
    });
    expect(tokens[24]).toEqual({
      value: "ispixel",
      scopes: ["source.css.less", "support.function.unit-checking.less"],
    });
    ...
    expect(tokens[39]).toEqual({
      value: "<",
      scopes: ["source.css.less", "keyword.operator.less"],
    });
  });
