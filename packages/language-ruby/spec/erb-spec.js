describe("TextMate HTML (Ruby - ERB) grammar", () => {
  ...
  it("tokenizes embedded ruby", () => {
    ...
    expect(tokens[0]).toEqual({
      value: "<%=",
      scopes: ["text.html.erb", "meta.embedded.line.erb", "punctuation.section.embedded.begin.erb"],
    });
    expect(tokens[1]).toEqual({
      value: " ",
      scopes: ["text.html.erb", "meta.embedded.line.erb", "source.ruby.embedded.erb"],
    });
    ...
    expect(tokens[4]).toEqual({
      value: "%>",
      scopes: ["text.html.erb", "meta.embedded.line.erb", "punctuation.section.embedded.end.erb"],
    });
    ...
    expect(lines[2][0]).toEqual({
      value: "%>",
      scopes: ["text.html.erb", "meta.embedded.block.erb", "punctuation.section.embedded.end.erb"],
    });
  });
});
