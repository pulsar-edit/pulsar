describe("TextMate Ruby grammar", function () {
  ...
  it("tokenizes special functions", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "require",
      scopes: ["source.ruby", "meta.require.ruby", "keyword.other.special-method.ruby"],
    });
  ...
  it("tokenizes variable constants", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "VAR1",
      scopes: ["source.ruby", "variable.other.constant.ruby"],
    });
  ...
  it("tokenizes symbol as hash key (1.9 syntax)", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "foo",
      scopes: ["source.ruby", "constant.other.symbol.hashkey.ruby"],
    });
    expect(tokens[1]).toEqual({
      value: ":",
      scopes: [
  ...
  it("tokenizes symbol as hash key (1.8 syntax)", function () {
    ...
    expect(tokens[3]).toEqual({
      value: "=>",
      scopes: ["source.ruby", "punctuation.separator.key-value.ruby"],
    });
  ...
  it("tokenizes :: separators", function () {
    ...
    expect(tokens[1]).toEqual({
      value: "::",
      scopes: ["source.ruby", "punctuation.separator.namespace.ruby"],
    });
    ...
    expect(tokens[0]).toEqual({
      value: "class",
      scopes: ["source.ruby", "meta.class.ruby", "keyword.control.class.ruby"],
    });
    expect(tokens[2]).toEqual({
      value: "A",
      scopes: ["source.ruby", "meta.class.ruby", "entity.name.type.class.ruby"],
    });
    expect(tokens[3]).toEqual({
      value: "::",
      scopes: ["source.ruby", "meta.class.ruby", "punctuation.separator.namespace.ruby"],
    });
    ...
    expect(tokens[8]).toEqual({
      value: "<",
      scopes: ["source.ruby", "meta.class.ruby", "punctuation.separator.inheritance.ruby"],
    });
    ...
    expect(tokens[2]).toEqual({
      value: "<<",
      scopes: ["source.ruby", "meta.class.ruby", "punctuation.definition.variable.ruby"],
    });
    expect(tokens[4]).toEqual({
      value: "A",
      scopes: [
    ...
    expect(tokens[0]).toEqual({
      value: "module",
      scopes: ["source.ruby", "meta.module.ruby", "keyword.control.module.ruby"],
    });
    expect(tokens[2]).toEqual({
      value: "A",
      scopes: ["source.ruby", "meta.module.ruby", "entity.other.inherited-class.module.ruby"],
    });
    expect(tokens[3]).toEqual({
      value: "::",
      scopes: ["source.ruby", "meta.module.ruby", "punctuation.separator.namespace.ruby"],
    });
    expect(tokens[4]).toEqual({
      value: "B",
      scopes: ["source.ruby", "meta.module.ruby", "entity.other.inherited-class.module.ruby"],
    ...
    expect(tokens[6]).toEqual({
      value: "C",
      scopes: ["source.ruby", "meta.module.ruby", "entity.name.type.module.ruby"],
    });
  });
  ...
  it("tokenizes , separator", function () {
    ...
    expect(tokens[3]).toEqual({
      value: "{",
      scopes: ["source.ruby", "punctuation.section.scope.begin.ruby"],
    });
    ...
    expect(tokens[9]).toEqual({
      value: "one",
      scopes: ["source.ruby", "string.quoted.single.ruby"],
    });
    expect(tokens[10]).toEqual({
      value: "'",
      scopes: [
    ...
    expect(tokens[11]).toEqual({
      value: ",",
      scopes: ["source.ruby", "punctuation.separator.delimiter.ruby"],
    });
    ...
    expect(tokens[20]).toEqual({
      value: "}",
      scopes: ["source.ruby", "punctuation.section.scope.end.ruby"],
    });
  ...
  it("tokenizes regular expressions", function () {
    ...
    expect(tokens[11]).toEqual({
      value: ";",
      scopes: ["source.ruby", "punctuation.terminator.statement.ruby"],
    });
    ...
    expect(tokens[4]).toEqual({
      value: "=~",
      scopes: ["source.ruby", "keyword.operator.comparison.ruby"],
    });
    ...
    expect(tokens[5]).toEqual({
      value: "do",
      scopes: ["source.ruby", "keyword.control.start-block.ruby"],
    });
    ...
    expect(tokens[4]).toEqual({
      value: "or",
      scopes: ["source.ruby", "keyword.operator.logical.ruby"],
    });
    expect(tokens[5]).toEqual({ value: " ", scopes: ["source.ruby"] });
    expect(tokens[6]).toEqual({
      value: "return",
      scopes: ["source.ruby", "keyword.control.pseudo-method.ruby"],
    });
...
`);
  ...
  it("tokenizes the / arithmetic operator", function () {
    ...
    expect(tokens[6]).toEqual({
      value: "/=",
      scopes: ["source.ruby", "keyword.operator.assignment.augmented.ruby"],
    });
    expect(tokens[7]).toEqual({ value: " ", scopes: ["source.ruby"] });
...
`);
    ...
    expect(tokens[0][8]).toEqual({
      value: " if the account does not have",
      scopes: ["source.ruby", "comment.line.number-sign.ruby", "comment.line.string.yard.ruby"],
    });
    expect(tokens[1][0]).toEqual({
      value: "#",
    ...
    expect(tokens[1][1]).toEqual({
      value: "   sufficient funds to perform the transaction",
      scopes: ["source.ruby", "comment.line.number-sign.ruby", "comment.line.string.yard.ruby"],
    });
...
`);
    ...
    expect(tokens[0][10]).toEqual({
      value: " describe value param in a long way which",
      scopes: ["source.ruby", "comment.line.number-sign.ruby", "comment.line.string.yard.ruby"],
    });
    expect(tokens[1][0]).toEqual({
      value: "#",
...
`);
    ...
    expect(tokens[0][8]).toEqual({
      value: " count the number of items",
      scopes: ["source.ruby", "comment.line.number-sign.ruby", "comment.line.string.yard.ruby"],
    });
    expect(tokens[1][0]).toEqual({
      value: "#",
  ...
  it("tokenizes a method with *args properly", function () {
    ...
    expect(tokens[3]).toEqual({
      value: " ",
      scopes: ["source.ruby", "meta.function.method.with-arguments.ruby"],
    });
    expect(tokens[4]).toEqual({
      value: "*",
      scopes: [
  ...
  it("tokenizes a method with (symbol: arg) properly", function () {
    ...
    expect(tokens[7]).toEqual({
      value: "2",
      scopes: ["source.ruby", "meta.function.method.with-arguments.ruby", "constant.numeric.ruby"],
    });
  });
  ...
  it("tokenizes a method with (symbol: arg(paren), symbol: arg2(paren)...) properly", function () {
    const { tokens } = grammar.tokenizeLine(
      "def method(red: rand(2), green: rand(3), blue: rand(4))",
    );
    expect(tokens[0]).toEqual({
      value: "def",
      scopes: [
    ...
    expect(tokens[11]).toEqual({
      ...
      scopes: [
        "source.ruby",
        "meta.function.method.with-arguments.ruby",
        "punctuation.separator.delimiter.ruby",
      ],
    });
    expect(tokens[13]).toEqual({
      value: "green",
  ...
  it("tokenizes a stabby lambda properly", function () {
    ...
    expect(tokens[1]).toEqual({
      value: "->",
      scopes: ["source.ruby", "support.function.kernel.arrow.ruby"],
    });
  });
  ...
  it("tokenizes a simple do block properly", function () {
    ...
    expect(tokens[2]).toEqual({
      value: "|",
      scopes: ["source.ruby", "punctuation.separator.variable.ruby"],
    });
    expect(tokens[3]).toEqual({
      value: "foo",
      scopes: ["source.ruby", "variable.other.block.ruby"],
    });
    expect(tokens[4]).toEqual({
      value: "|",
      scopes: ["source.ruby", "punctuation.separator.variable.ruby"],
  ...
  it("tokenizes a complex do block properly", function () {
    ...
    expect(tokens[26]).toEqual({
      value: "false",
      scopes: ["source.ruby", "constant.language.boolean.ruby"],
    });
    expect(tokens[27]).toEqual({
      value: "|",
      scopes: ["source.ruby", "punctuation.separator.variable.ruby"],
  ...
  it("tokenizes Kernel support functions autoload? and exit!", function () {
    ...
    expect(lines[0][2]).toEqual({
      value: "autoload?",
      scopes: ["source.ruby", "support.function.kernel.ruby"],
    });
