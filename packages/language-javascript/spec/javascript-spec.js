  ...
  describe("strings", function() {
    ...
    it("tokenizes invalid multiline strings", function() {
      ...
      return (() => {
        ...
        for (let scope in delimsByScope) {
          const delim = delimsByScope[scope];
          const lines = grammar.tokenizeLines(delim + `\
line1
line2\\
line3\
` + delim
      ...
      return it("highlights sequences with invalid codepoints", function() {
        ...
        return (() => {
          ...
          for (let codepoint of [0x5000, 0x11FFFF, 0x1000000, maxCodepoint]) {
            ...
            const pointScopes = ['source.js', 'string.quoted.double.js', 'constant.character.escape.js'];
  ...
  describe("operators", function() {
    ...
    return describe("assignment", function() {
      ...
      return describe("compound", function() {
        ...
        describe("logical", () => it("tokenizes them", function() {
          const operators = ["||=", "&&=", "??="];
          return (() => {
            const result = [];
            for (let operator of Array.from(operators)) {
