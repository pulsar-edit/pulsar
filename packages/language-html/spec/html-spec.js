...
`);
      ...
      expect(lines[0][0]).toEqual({
        value: "<",
        scopes: ["text.html.basic", "meta.tag.style.html", "punctuation.definition.tag.html"],
      });
      expect(lines[0][1]).toEqual({
        value: "style",
        scopes: ["text.html.basic", "meta.tag.style.html", "entity.name.tag.style.html"],
      });
...
`);
      ...
      expect(lines[1][0]).toEqual({
        value: "  ",
        scopes: ["text.html.basic", "meta.tag.style.html", "source.css.embedded.html"],
      });
      expect(lines[1][1]).toEqual({
        value: "span",
        scopes: [
...
`);
      ...
      expect(lines[0][1]).toEqual({
        value: "script",
        scopes: ["text.html.basic", "meta.tag.script.html", "entity.name.tag.script.html"],
      });
      expect(lines[0][3]).toEqual({
        value: "id",
        scopes: [
...
`);
      ...
      expect(lines[1][0]).toEqual({
        value: "  ",
        scopes: ["text.html.basic", "meta.tag.script.html", "text.embedded.html"],
      });
      expect(lines[1][1]).toEqual({
        value: "<",
        scopes: [
...
`);
      ...
      expect(lines[1][0]).toEqual({
        value: "  ",
        scopes: ["text.html.basic", "meta.tag.script.html", "source.js.embedded.html"],
      });
      expect(lines[1][1]).toEqual({
        value: "var",
        scopes: [
...
`);
  ...
  describe("comments", () =>
    it("tokenizes -- as an error", function () {
      let { tokens } = grammar.tokenizeLine("<!-- some comment --->");

      expect(tokens[0]).toEqual({
        value: "<!--",
        scopes: ["text.html.basic", "comment.block.html", "punctuation.definition.comment.html"],
      });
      expect(tokens[1]).toEqual({
        value: " some comment -",
        scopes: ["text.html.basic", "comment.block.html"],
      });
  ...
  describe("attributes", function () {
    ...
    it("recognizes multiple attributes with varying values", function () {
      ...
      expect(tokens[8]).toEqual({
        value: " ",
        scopes: ["text.html.basic", "meta.tag.inline.span.html"],
      });
      expect(tokens[9]).toEqual({
        value: "disabled",
        scopes: [
    ...
    describe("the 'style' attribute", function () {
      ...
      for (quote in quotes) {
        ...
        it(`tokenizes ${type}-quoted style attribute values as CSS property lists`, function () {
          ...
          ({ tokens } = grammar.tokenizeLine(
            `<span style=${quote}display: none; z-index: 10;${quote}>`,
          ));
...
`);
  ...
  describe("character references", function () {
    ...
    it("tokenizes invalid ampersands", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "&",
        scopes: ["text.html.basic", "invalid.illegal.bad-ampersand.html"],
      });
    ...
    it("does not tokenize query parameters as character references", function () {
      const { tokens } = grammar.tokenizeLine(
        '<a href="http://example.com?one=1&type=json&topic=css">',
      );
      expect(tokens[6]).toEqual({
        value: "http://example.com?one=1&type=json&topic=css",
        scopes: [
          "text.html.basic",
          "meta.tag.inline.a.html",
          "meta.attribute-with-value.html",
    ...
    it("does not tokenize multiple ampersands followed by alphabetical characters as character references", function () {
      const { tokens } = grammar.tokenizeLine(
        '<a href="http://example.com?price&something&yummy:&wow">',
      );
      expect(tokens[6]).toEqual({
        value: "http://example.com?price&something&yummy:&wow",
        scopes: [
          "text.html.basic",
          "meta.tag.inline.a.html",
          "meta.attribute-with-value.html",
...
`;
  ...
  describe("tags", function () {
    ...
    it("tokenizes structure tags as such", function () {
      ...
      expect(tokens[1]).toEqual({
        ...
        scopes: [
          "text.html.basic",
          "meta.tag.structure.html.html",
          "entity.name.tag.structure.html.html",
        ],
      });
      expect(tokens[2]).toEqual({
        value: ">",
    ...
    it("tokenizes block tags as such", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "div",
        scopes: ["text.html.basic", "meta.tag.block.div.html", "entity.name.tag.block.div.html"],
      });
      expect(tokens[2]).toEqual({
        value: ">",
        scopes: [
    ...
    it("tokenizes other tags as such", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "<",
        scopes: ["text.html.basic", "meta.tag.other.html", "punctuation.definition.tag.begin.html"],
      });
      expect(tokens[1]).toEqual({
        value: "foo",
        scopes: ["text.html.basic", "meta.tag.other.html", "entity.name.tag.other.html"],
      });
      expect(tokens[2]).toEqual({
        value: ">",
        scopes: ["text.html.basic", "meta.tag.other.html", "punctuation.definition.tag.end.html"],
      });
    });
    ...
    it("tokenizes XML declaration correctly", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "xml",
        scopes: ["text.html.basic", "meta.tag.preprocessor.xml.html", "entity.name.tag.xml.html"],
      });
      expect(tokens[2]).toEqual({
        value: " ",
        scopes: ["text.html.basic", "meta.tag.preprocessor.xml.html"],
      });
      expect(tokens[3]).toEqual({
        value: "version",
        scopes: [
  ...
  describe("snippets", function () {
    ...
    it("suggests snippets", () =>
      expect(
        Object.keys(snippetsModule.parsedSnippetsForScopes([".text.html"])).length,
      ).toBeGreaterThan(10));

    it("does not suggest any HTML snippets when in embedded scripts", () =>
      expect(
        Object.keys(snippetsModule.parsedSnippetsForScopes([".text.html .source.js.embedded.html"]))
          .length,
      ).toBe(0));
  });
});
