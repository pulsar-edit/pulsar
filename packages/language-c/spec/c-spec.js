      ...
      it("tokenizes '#pragma'", function () {
        ...
        expect(tokens[3]).toEqual({
          ...
          scopes: [
            "source.c",
            "meta.preprocessor.pragma.c",
            "entity.other.attribute-name.pragma.preprocessor.c",
          ],
        });
          ...
          it("tokenizes them", function () {
            ...
            expect(tokens[14]).toEqual({
              ...
              scopes: [
                ...
                "meta.preprocessor.macro.c",
                "meta.block.c",
                "keyword.operator.assignment.compound.bitwise.c",
              ],
            });
            expect(tokens[15]).toEqual({
              value: " b",
        ...
        it("tokenizes '#include_next'", function () {
          ...
          expect(tokens[0]).toEqual({
            ...
            scopes: [
              "source.c",
              "meta.preprocessor.include.c",
              "keyword.control.directive.include_next.c",
              "punctuation.definition.directive.c",
            ],
          });
          expect(tokens[1]).toEqual({
...
`);
    ...
    describe("operators", () =>
      it("tokenizes ternary operators with namespace resolution", function () {
