...
`);
  ...
  it("tokenizes comment endings with more than two dashes as invalid", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "<!--",
      scopes: ["text.xml", "comment.block.xml", "punctuation.definition.comment.xml"],
    });
    expect(tokens[1]).toEqual({
      value: " invalid comment ",
      scopes: ["text.xml", "comment.block.xml"],
    });
    expect(tokens[2]).toEqual({
      value: "--",
      scopes: ["text.xml", "comment.block.xml", "invalid.illegal.bad-comments-or-CDATA.xml"],
    });
  });
  ...
  it("tokenizes empty element meta.tag.no-content.xml", function () {
    ...
    expect(tokens[0]).toEqual({
      value: "<",
      scopes: ["text.xml", "meta.tag.no-content.xml", "punctuation.definition.tag.xml"],
    });
    expect(tokens[1]).toEqual({
      value: "n",
      scopes: [
...
`);
    expect(linesWithIndent[1][1]).toEqual({
      value: "attrName",
      scopes: ["text.xml", "meta.tag.xml", "entity.other.attribute-name.localname.xml"],
    });
...
`);
    expect(linesWithoutIndent[1][0]).toEqual({
      value: "attrName",
      scopes: ["text.xml", "meta.tag.xml", "entity.other.attribute-name.localname.xml"],
    });
  });
...
`);
    expect(lines[0][3]).toEqual({
      value: "name.space",
      scopes: ["text.xml", "meta.tag.xml", "entity.other.attribute-name.namespace.xml"],
    });
  });
