...
describe("BufferView", () => {
  it("shows the avatar for editors that are remote", async () => {
    ...
    expect(bufferView.items).toEqual([
      {
        uri: localEditor1.getURI(),
        filePath: localEditor1.getPath(),
        label: localEditor1.getPath(),
      },
      {
        uri: localEditor2.getURI(),
        filePath: localEditor2.getPath(),
        label: localEditor2.getPath(),
      },
      {
        uri: "remote1-uri",
        filePath: "remote1-path",
        label: "@user-1: remote1-path",
