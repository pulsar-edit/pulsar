describe("SassDoc grammar", function () {
  ...
  describe("block tags", function () {
    it("tokenises simple tags", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.css.scss",
          "comment.block.documentation.scss",
          "punctuation.definition.comment.scss",
        ],
      });
      expect(tokens[1]).toEqual({
        value: " ",
        scopes: ["source.css.scss", "comment.block.documentation.scss"],
      });
      expect(tokens[2]).toEqual({
        ...
        scopes: [
          ...
          "punctuation.definition.block.tag.sassdoc",
        ],
      });
    ...
    it("tokenises @param tags with a description", function () {
      ...
      expect(tokens[5]).toEqual({
        ...
        scopes: [
          ...
          "punctuation.definition.bracket.curly.begin.sassdoc",
        ],
      });
      ...
      expect(tokens[7]).toEqual({
        ...
        scopes: [
          ...
          "comment.block.documentation.scss",
          "entity.name.type.instance.sassdoc",
          "punctuation.definition.bracket.curly.end.sassdoc",
        ],
      });
      expect(tokens[9]).toEqual({
        value: "$name",
        scopes: ["source.css.scss", "comment.block.documentation.scss", "variable.other.sassdoc"],
      });
  ...
  describe("highlighted examples", () =>
    it("highlights SCSS after an @example tag", function () {
