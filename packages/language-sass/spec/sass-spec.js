describe("Sass grammar", function () {
  ...
  describe("vendor-prefixed properties", () =>
    it("tokenizes them as properties", function () {
      const tokens = grammar.tokenizeLines(`\
.something
  -webkit-mask-repeat: no-repeat\
`);
      expect(tokens[1][1]).toEqual({
        value: "-webkit-mask-repeat",
        scopes: [
          "source.sass",
...
`);
      expect(tokens[1][1]).toEqual({
        value: "color",
        scopes: ["source.sass", "meta.property-name.sass", "support.type.property-name.css"],
      });
      expect(tokens[1][2]).toEqual({
        value: ":",
        scopes: ["source.sass", "meta.property-value.sass", "punctuation.separator.key-value.css"],
      });
      expect(tokens[1][3]).toEqual({
        value: " ",
        scopes: ["source.sass", "meta.property-value.sass"],
      });
      expect(tokens[1][4]).toEqual({
        value: "inherit",
        scopes: ["source.sass", "meta.property-value.sass", "support.constant.property-value.css"],
      });
    });
...
`);
      expect(tokens[1][1]).toEqual({
        value: ":",
        scopes: ["source.sass", "punctuation.separator.key-value.css"],
      });
      expect(tokens[1][2]).toEqual({
        value: "color",
        scopes: ["source.sass", "meta.property-name.sass", "support.type.property-name.css"],
...
`);
      expect(tokens[0][0]).toEqual({
        value: "a",
        scopes: ["source.sass", "meta.selector.css", "entity.name.tag.css"],
      });
...
`);
      ...
      expect(tokens[0][5]).toEqual({
        value: "selected",
        scopes: ["source.sass", "meta.selector.css", "entity.other.attribute-name.class.css"],
      });
      ...
      it("tokenizes a single attribute selector", function () {
        ...
        expect(tokens[0]).toEqual({
          ...
          scopes: [
            "source.sass",
            "meta.selector.css",
            "meta.attribute-selector.css.sass",
            "punctuation.definition.attribute-selector.begin.bracket.square.sass",
          ],
        });
        ...
        expect(tokens[3]).toEqual({
          ...
          scopes: [
            ...
            "meta.selector.css",
            "meta.attribute-selector.css.sass",
            "string.quoted.double.attribute-value.sass",
            "punctuation.definition.string.begin.sass",
          ],
        });
        ...
        expect(tokens[5]).toEqual({
          ...
          scopes: [
            ...
            "meta.attribute-selector.css.sass",
            "string.quoted.double.attribute-value.sass",
            "punctuation.definition.string.end.sass",
          ],
        });
        expect(tokens[6]).toEqual({
          ...
          scopes: [
            ...
            "meta.selector.css",
            "meta.attribute-selector.css.sass",
            "punctuation.definition.attribute-selector.end.bracket.square.sass",
          ],
        });
      });
...
`);
      expect(tokens[1][4]).toEqual({
        value: "50",
        scopes: ["source.sass", "meta.property-value.sass", "constant.numeric.css"],
      });
    });
...
`);
      expect(tokens[1][7]).toEqual({
        value: "-",
        scopes: ["source.sass", "meta.property-value.sass", "keyword.operator.css"],
      });
    });
  });
  ...
  describe("variables", function () {
    it("tokenizes them", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.variable-declaration.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
        value: "test",
        scopes: ["source.sass", "meta.variable-declaration.sass", "variable.other.sass"],
      });
      expect(tokens[2]).toEqual({
        value: ":",
        scopes: [
      ...
      expect(tokens[3]).toEqual({
        value: " ",
        scopes: ["source.sass", "meta.variable-declaration.sass", "meta.property-value.sass"],
      });
      expect(tokens[4]).toEqual({
        value: "bla",
        scopes: ["source.sass", "meta.variable-declaration.sass", "meta.property-value.sass"],
...
`);
      expect(tokens[1][4]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.property-value.sass",
          "string.quoted.single.sass",
          "punctuation.definition.string.begin.sass",
        ],
      });
      expect(tokens[1][5]).toEqual({
        value: "hi",
        scopes: ["source.sass", "meta.property-value.sass", "string.quoted.single.sass"],
      });
...
`);
      ...
      expect(tokens[1][5]).toEqual({
        value: "hi",
        scopes: ["source.sass", "meta.property-value.sass", "string.quoted.double.sass"],
      });
      expect(tokens[1][6]).toEqual({
        value: '"',
        scopes: [
...
`);
      expect(tokens[1][5]).toEqual({
        ...
        scopes: [
          ...
          "meta.property-value.sass",
          "string.quoted.single.sass",
          "constant.character.escape.sass",
        ],
      });
...
`);
  ...
  describe("comments", function () {
    it("only tokenizes comments that start at the beginning of a line", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "//",
        scopes: ["source.sass", "comment.line.sass", "punctuation.definition.comment.sass"],
      });
      expect(tokens[2]).toEqual({
        value: "A comment?",
        scopes: ["source.sass", "comment.line.sass"],
      });
      ...
      expect(tokens[0]).toEqual({
        value: "/*",
        scopes: ["source.sass", "comment.block.sass", "punctuation.definition.comment.sass"],
      });
      expect(tokens[1]).toEqual({
        value: " also a comment ",
        scopes: ["source.sass", "comment.block.sass"],
      });
      expect(tokens[2]).toEqual({
        value: "*/",
        scopes: ["source.sass", "comment.block.sass", "punctuation.definition.comment.sass"],
      ...
      expect(tokens[1]).toEqual({
        ...
        scopes: ["source.sass", "meta.selector.css", "invalid.illegal.sass"],
      });

      ({ tokens } = grammar.tokenizeLine("this /* is also not a comment */"));
      expect(tokens[1]).toEqual({
        value: "/* is also not a comment */",
        scopes: ["source.sass", "meta.selector.css", "invalid.illegal.sass"],
      });
    });
...
`);
      ...
      expect(tokens[0][0]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.media.sass",
          "keyword.control.at-rule.media.sass",
          "punctuation.definition.keyword.sass",
        ],
      });
      expect(tokens[0][1]).toEqual({
        value: "media",
        scopes: ["source.sass", "meta.at-rule.media.sass", "keyword.control.at-rule.media.sass"],
      });
      expect(tokens[0][2]).toEqual({
        value: " ",
        scopes: ["source.sass", "meta.at-rule.media.sass"],
      });
      expect(tokens[0][3]).toEqual({
        value: "screen",
        scopes: ["source.sass", "meta.at-rule.media.sass", "support.constant.media.css"],
      });
      expect(tokens[1][1]).toEqual({
        value: "background",
        scopes: ["source.sass", "meta.property-name.sass", "support.type.property-name.css"],
...
`);
      ...
      expect(tokens[0][3]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.media.sass",
          "meta.property-list.media-query.sass",
          "punctuation.definition.media-query.begin.bracket.round.sass",
        ],
      });
      expect(tokens[0][4]).toEqual({
        value: "orientation",
        scopes: [
          ...
          "meta.at-rule.media.sass",
          "meta.property-list.media-query.sass",
          "meta.property-name.media-query.sass",
      ...
      expect(tokens[0][5]).toEqual({
        ...
        scopes: [
          ...
          "meta.at-rule.media.sass",
          "meta.property-list.media-query.sass",
          "punctuation.separator.key-value.sass",
        ],
      });
      expect(tokens[0][6]).toEqual({
        value: " ",
        scopes: ["source.sass", "meta.at-rule.media.sass", "meta.property-list.media-query.sass"],
      });
      expect(tokens[0][7]).toEqual({
        ...
        scopes: [
          ...
          "meta.at-rule.media.sass",
          "meta.property-list.media-query.sass",
          "meta.property-value.media-query.sass",
      ...
      expect(tokens[0][8]).toEqual({
        ...
        scopes: [
          ...
          "meta.at-rule.media.sass",
          "meta.property-list.media-query.sass",
          "punctuation.definition.media-query.end.bracket.round.sass",
        ],
      });
      ...
      expect(tokens[0][10]).toEqual({
        value: "and",
        scopes: ["source.sass", "meta.at-rule.media.sass", "keyword.operator.logical.sass"],
      });
    ...
    it("tokenizes @function", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "function_name",
        scopes: ["source.sass", "meta.at-rule.function.sass", "support.function.misc.sass"],
      });
      expect(tokens[5]).toEqual({
        value: "$",
        scopes: [
    ...
    it("tokenizes @return", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "return",
        scopes: ["source.sass", "meta.at-rule.return.sass", "keyword.control.return.sass"],
      });
      expect(tokens[4]).toEqual({
        value: "border",
        scopes: ["source.sass", "meta.at-rule.return.sass", "string.quoted.single.sass"],
      });
      expect(tokens[7]).toEqual({
        value: "+",
        scopes: ["source.sass", "meta.at-rule.return.sass", "keyword.operator.css"],
      });
    });
    ...
    it("tokenizes @if", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "if",
        scopes: ["source.sass", "meta.at-rule.if.sass", "keyword.control.if.sass"],
      });
      expect(tokens[3]).toEqual({
        value: "$",
        scopes: [
      ...
      expect(tokens[6]).toEqual({
        value: "==",
        scopes: ["source.sass", "meta.at-rule.if.sass", "keyword.operator.comparison.sass"],
      });
      expect(tokens[8]).toEqual({
        value: "true",
        scopes: ["source.sass", "meta.at-rule.if.sass", "support.constant.property-value.css.sass"],
      });
      ...
      expect(tokens[4]).toEqual({
        ...
        scopes: [
          ...
          "meta.at-rule.if.sass",
          "meta.variable-usage.sass",
          "punctuation.access.module.sass",
        ],
      });
      expect(tokens[5]).toEqual({
        value: "$",
    ...
    it("tokenizes @else if", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.else.sass",
          "keyword.control.else.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
        value: "else if ",
        scopes: ["source.sass", "meta.at-rule.else.sass", "keyword.control.else.sass"],
      });
      expect(tokens[2]).toEqual({
        value: "$",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "==",
        scopes: ["source.sass", "meta.at-rule.else.sass", "keyword.operator.comparison.sass"],
      });
      expect(tokens[7]).toEqual({
        value: "false",
        scopes: [
    ...
    it("tokenizes @while", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.while.sass",
          "keyword.control.while.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
        value: "while",
        scopes: ["source.sass", "meta.at-rule.while.sass", "keyword.control.while.sass"],
      });
      expect(tokens[3]).toEqual({
        value: "1",
        scopes: ["source.sass", "meta.at-rule.while.sass", "constant.numeric.css"],
      });
    });
    ...
    it("tokenizes @for", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.for.sass",
          "keyword.control.for.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
        value: "for",
        scopes: ["source.sass", "meta.at-rule.for.sass", "keyword.control.for.sass"],
      });
      expect(tokens[3]).toEqual({
        value: "$",
        scopes: [
      ...
      expect(tokens[8]).toEqual({
        value: "1",
        scopes: ["source.sass", "meta.at-rule.for.sass", "constant.numeric.css"],
      });
      expect(tokens[12]).toEqual({
        value: "100",
        scopes: ["source.sass", "meta.at-rule.for.sass", "constant.numeric.css"],
    ...
    it("tokenizes @each", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          ...
          "keyword.control.each.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
        value: "each",
        scopes: ["source.sass", "meta.at-rule.each.sass", "keyword.control.each.sass"],
      });
      expect(tokens[3]).toEqual({
        value: "$",
        scopes: [
    ...
    it("tokenizes @include", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "mixin-name",
        scopes: ["source.sass", "meta.function.include.sass", "variable.other.sass"],
      });
      ...
      expect(tokens[3]).toEqual({
        value: "mixin",
        scopes: ["source.sass", "meta.function.include.sass", "variable.sass"],
      });
      expect(tokens[4]).toEqual({
        value: ".",
        scopes: ["source.sass", "meta.function.include.sass", "punctuation.access.module.sass"],
      });
      expect(tokens[5]).toEqual({
        value: "name",
        scopes: ["source.sass", "meta.function.include.sass", "variable.other.sass"],
    ...
    it("tokenizes @mixin or '='", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          ...
          "keyword.control.at-rule.mixin.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
      ...
      expect(tokens[3]).toEqual({
        value: "mixin-name",
        scopes: ["source.sass", "meta.variable-declaration.sass.mixin", "variable.other.sass"],
      });
      expect(tokens[5]).toEqual({
        value: "$",
        scopes: [
...
`);
      expect(tokens[1][1]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.content.sass",
          "keyword.control.content.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1][2]).toEqual({
        value: "content",
        scopes: ["source.sass", "meta.at-rule.content.sass", "keyword.control.content.sass"],
      });
    });
    ...
    it("tokenizes @warn, @debug and @error", function () {
      ...
      expect(tokens[0]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.warn.sass",
          "keyword.control.warn.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1]).toEqual({
        value: "warn",
        scopes: ["source.sass", "meta.at-rule.warn.sass", "keyword.control.warn.sass"],
      });
      expect(tokens[4]).toEqual({
        value: "message",
        scopes: ["source.sass", "meta.at-rule.warn.sass", "string.quoted.single.sass"],
      });
...
`);
      expect(tokens[1][1]).toEqual({
        ...
        scopes: [
          "source.sass",
          "meta.at-rule.at-root.sass",
          "keyword.control.at-root.sass",
          "punctuation.definition.entity.sass",
        ],
      });
      expect(tokens[1][2]).toEqual({
        value: "at-root",
        scopes: ["source.sass", "meta.at-rule.at-root.sass", "keyword.control.at-root.sass"],
      });
      expect(tokens[2][1]).toEqual({
        value: "#",
        scopes: [
      ...
      expect(tokens[2][2]).toEqual({
        value: "id",
        scopes: ["source.sass", "meta.selector.css", "entity.other.attribute-name.id.css.sass"],
      });
    });
    ...
    describe("@use", function () {
      it("tokenizes @use with explicit namespace correctly", function () {
        ...
        expect(tokens[1]).toEqual({
          value: "use",
          scopes: ["source.sass", "meta.at-rule.use.sass", "keyword.control.at-rule.use.sass"],
        });
        expect(tokens[3]).toEqual({
          value: "'",
          scopes: [
        ...
        expect(tokens[4]).toEqual({
          value: "module",
          scopes: ["source.sass", "meta.at-rule.use.sass", "string.quoted.single.sass"],
        });
        expect(tokens[7]).toEqual({
          value: "as",
          scopes: ["source.sass", "meta.at-rule.use.sass", "keyword.control.operator"],
        });
        expect(tokens[9]).toEqual({
          value: "_mod-ule",
          scopes: ["source.sass", "meta.at-rule.use.sass", "variable.sass"],
        });
      });
      ...
      it("tokenizes @use with configuration correctly", function () {
        const { tokens } = grammar.tokenizeLine(
          "@use 'module' with ($black: #222, $border-radius: 0.1rem)",
        );
        ...
        expect(tokens[9]).toEqual({
          ...
          scopes: [
            "source.sass",
            "meta.at-rule.use.sass",
            "punctuation.definition.module.begin.bracket.round.sass",
          ],
        });
        expect(tokens[10]).toEqual({
          value: "$",
    ...
    describe("@forward", function () {
      it("tokenizes solitary @forward correctly", function () {
        ...
        expect(tokens[0]).toEqual({
          ...
          scopes: [
            "source.sass",
            "meta.at-rule.forward.sass",
            "keyword.control.at-rule.forward.sass",
            "punctuation.definition.keyword.sass",
          ],
        });
        expect(tokens[1]).toEqual({
      ...
      it("tokenizes @forward with path correctly", function () {
        ...
        expect(tokens[4]).toEqual({
          value: "module",
          scopes: ["source.sass", "meta.at-rule.forward.sass", "string.quoted.single.sass"],
        });
      });
      ...
      it("tokenizes @forward with prefix correctly", function () {
        ...
        expect(tokens[7]).toEqual({
          value: "as",
          scopes: ["source.sass", "meta.at-rule.forward.sass", "keyword.control.operator"],
        });
        expect(tokens[9]).toEqual({
          value: "prefix",
          scopes: [
            "source.sass",
            "meta.at-rule.forward.sass",
            "entity.other.attribute-name.module.sass",
          ],
        });
        expect(tokens[10]).toEqual({
          value: "*",
          scopes: [
            "source.sass",
            "meta.at-rule.forward.sass",
            "punctuation.definition.wildcard.sass",
          ],
        });
      });
      ...
      it("tokenizes @forward with hide correctly", function () {
        ...
        expect(tokens[9]).toEqual({
          value: "a-mixin",
          scopes: ["source.sass", "meta.at-rule.forward.sass", "entity.name.function.sass"],
        });
        expect(tokens[11]).toEqual({
          value: "$",
          scopes: [
      ...
      it("tokenizes @forward with show correctly", function () {
        const { tokens } = grammar.tokenizeLine(
          "@forward 'module' show public-mixin $public-variable",
        );
  ...
  describe("operators", function () {
    it("correctly tokenizes comparison and logical operators", function () {
      ...
      expect(tokens[9]).toEqual({
        value: "and",
        scopes: ["source.sass", "meta.at-rule.if.sass", "keyword.operator.logical.sass"],
      });
    ...
    it("correctly tokenizes control operators", function () {
      ...
      expect(tokens[6]).toEqual({
        value: "from",
        scopes: ["source.sass", "meta.at-rule.for.sass", "keyword.operator.control.sass"],
      });
      expect(tokens[10]).toEqual({
        value: "through",
        scopes: ["source.sass", "meta.at-rule.for.sass", "keyword.operator.control.sass"],
      ...
      expect(tokens[6]).toEqual({
        value: "in",
        scopes: ["source.sass", "meta.at-rule.each.sass", "keyword.operator.control.sass"],
      });
    });
...
`);
        expect(tokens[1][4]).toEqual({
          value: "fonts",
          scopes: ["source.sass", "meta.property-value.sass", "variable.sass"],
        });
        expect(tokens[1][5]).toEqual({
          value: ".",
          scopes: ["source.sass", "meta.property-value.sass", "punctuation.access.module.sass"],
        });
        expect(tokens[1][6]).toEqual({
          value: "size",
          scopes: ["source.sass", "meta.property-value.sass", "support.function.misc.sass"],
        });
        expect(tokens[1][7]).toEqual({
          value: "(",
          scopes: ["source.sass", "meta.property-value.sass", "punctuation.section.function.sass"],
        });
