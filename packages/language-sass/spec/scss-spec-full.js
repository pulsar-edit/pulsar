describe("SCSS grammar", function () {
    ...
    it("tokenizes them correctly", function () {
      ...
      expect(tokens[4]).toEqual({
        ...
        scopes: [
          ...
          "meta.definition.variable.map.scss",
  ...
  describe("selectors", function () {
    ...
    return (() => {
      ...
      for (var scope in selectors) {
        ...
        it(`tokenizes invalid identifiers in ${scope} selectors`, function () {
          ...
          expect(tokens[6]).toEqual({
            ...
            scopes: [
              "source.css.scss",
              `entity.other.attribute-name.${scope}.css`,
              "invalid.illegal.identifier.scss",
            ],
          });
          expect(tokens[7]).toEqual({
            value: "a",
        ...
        result.push(
          it("tokenizes placeholder selectors in at-rules", function () {
            ...
            expect(tokens[5]).toEqual({
              value: ";",
              scopes: ["source.css.scss", "punctuation.terminator.rule.css"],
            });
          }),
        );
      }
  ...
  describe("attribute selectors", function () {
    it("tokenizes them correctly", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "=",
        scopes: ["source.css.scss", "meta.attribute-selector.scss", "keyword.operator.scss"],
      });
      expect(tokens[3]).toEqual({
        value: '"',
        scopes: [
  ...
  describe("@include", function () {
    it("tokenizes it correctly", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "media",
        scopes: ["source.css.scss", "meta.at-rule.include.scss", "entity.name.function.scss"],
      });
      expect(tokens[4]).toEqual({
        value: "{",
        scopes: [
    ...
    it("tokenizes correctly for includes from a module", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "media",
        scopes: ["source.css.scss", "meta.at-rule.include.scss", "variable.scss"],
      });
      expect(tokens[4]).toEqual({
        value: ".",
        scopes: ["source.css.scss", "meta.at-rule.include.scss", "punctuation.access.module.scss"],
      });
      expect(tokens[5]).toEqual({
        value: "breakpoint",
        scopes: ["source.css.scss", "meta.at-rule.include.scss", "entity.name.function.scss"],
  ...
  describe("@mixin", function () {
    ...
    it("tokenizes @mixin with no arguments correctly", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "media",
        scopes: ["source.css.scss", "meta.at-rule.mixin.scss", "entity.name.function.scss"],
      });
      expect(tokens[4]).toEqual({
        value: "{",
        scopes: [
  ...
  describe("@namespace", function () {
    ...
    it("tokenizes default namespace definition with url() correctly", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "url",
        scopes: ["source.css.scss", "meta.at-rule.namespace.scss", "support.function.misc.scss"],
      });
    });
...
`);
  ...
  describe("@supports", function () {
    ...
    it('tokenizes @supports with negation, testing for "flex" as value', function () {
      ...
      expect(tokens[3]).toEqual({
        value: "not",
        scopes: ["source.css.scss", "meta.at-rule.supports.scss", "keyword.operator.logical.scss"],
      });
      expect(tokens[5]).toEqual({
        value: "(",
        scopes: [
          "source.css.scss",
          "meta.at-rule.supports.scss",
          "punctuation.definition.condition.begin.bracket.round.scss",
        ],
      });
      expect(tokens[7]).toEqual({
        value: "display",
    ...
    it('tokenizes @supports with disjunction, testing for "flex" as property', function () {
      const { tokens } = grammar.tokenizeLine(
        "@supports (flex:2 2) or (  -webkit-flex  : 2 2)  {}",
      );
  ...
  describe("property-list", function () {
    it("tokenizes the property-name and property-value", function () {
      ...
      expect(tokens[8]).toEqual({
        value: ";",
        scopes: ["source.css.scss", "meta.property-list.scss", "punctuation.terminator.rule.scss"],
      });
      expect(tokens[10]).toEqual({
        value: "}",
        scopes: [
    ...
    it("tokenizes nested property-lists", function () {
      const { tokens } = grammar.tokenizeLine(
        "very-custom { very-very-custom { color: inherit; } margin: top; }",
      );
      ...
      expect(tokens[4]).toEqual({
        ...
        scopes: ["source.css.scss", "meta.property-list.scss", "entity.name.tag.custom.scss"],
      });
      expect(tokens[6]).toEqual({
        value: "{",
        scopes: [
...
`);
    ...
    describe("property values", () =>
      it("tokenizes parentheses", function () {
        const { tokens } = grammar.tokenizeLine(
          ".foo { margin: ($bar * .8) 0 ($bar * .8) (foo.$bar * 2);",
        );
        expect(tokens[8]).toEqual({
          value: "(",
          scopes: [
...
`);
      ...
      expect(tokens[0][0]).toEqual({
        value: "text",
        scopes: ["source.css.scss", "entity.name.tag.css"],
      });
      expect(tokens[1][0]).toEqual({
        value: "  ",
        scopes: ["source.css.scss", "meta.property-list.scss"],
...
`);
  ...
  describe("vendor properties", () =>
    it("tokenizes the browser prefix", function () {
    ...
    it("tokenizes them with attribute selectors", function () {
      ...
      expect(tokens[4]).toEqual({
        ...
        scopes: [
          "source.css.scss",
          "meta.attribute-selector.scss",
          "string.quoted.single.attribute-value.scss",
          "punctuation.definition.string.begin.scss",
        ],
      });
      expect(tokens[5]).toEqual({
...
`);
  ...
  describe("pseudo classes", function () {
    ...
    it("tokenizes nth-* pseudo classes", function () {
      ...
      expect(tokens[4]).toEqual({
        value: "3",
        scopes: ["source.css.scss", "constant.numeric.css"],
      });
      ...
      expect(tokens[4]).toEqual({
        value: "hi",
        scopes: ["source.css.scss", "invalid.illegal.scss"],
      });
      expect(tokens[5]).toEqual({
        value: ")",
        scopes: ["source.css.scss", "punctuation.definition.pseudo-class.end.bracket.round.css"],
    ...
    it("tokenizes complex pseudo classes", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "&",
        scopes: ["source.css.scss", "entity.name.tag.reference.scss"],
      });
      expect(tokens[1]).toEqual({
        value: ":",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "$j",
        scopes: ["source.css.scss", "variable.interpolation.scss", "variable.scss"],
      });
      expect(tokens[6]).toEqual({
        value: "}",
        scopes: [
  ...
  describe("pseudo elements", () =>
    it("inherits the matching from language-css", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "after",
        scopes: ["source.css.scss", "entity.other.attribute-name.pseudo-element.css"],
      });
    }));
  ...
  describe("functional pseudo classes", () =>
    it("inherits the matching from language-css", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "(",
        scopes: ["source.css.scss", "punctuation.section.function.begin.bracket.round.css"],
      });
      expect(tokens[4]).toEqual({
        value: ".",
        scopes: [
      ...
      expect(tokens[6]).toEqual({
        value: ")",
        scopes: ["source.css.scss", "punctuation.section.function.end.bracket.round.css"],
      });
    }));
...
`);
  ...
  describe("media queries", () =>
    it("parses media types and features", function () {
      ...
      expect(tokens[2]).toEqual({
        value: " ",
        scopes: ["source.css.scss", "meta.at-rule.media.scss"],
      });
      expect(tokens[3]).toEqual({
        value: "screen",
        scopes: ["source.css.scss", "meta.at-rule.media.scss", "support.constant.media.css"],
      });
      expect(tokens[4]).toEqual({
        value: " ",
        scopes: ["source.css.scss", "meta.at-rule.media.scss"],
      ...
      ({ tokens } = grammar.tokenizeLine(
        "@media (orientation: landscape) and (min-width: 700px) /* comment */ {}",
      ));
      ...
      expect(tokens[7]).toEqual({
        ...
        scopes: [
          ...
          "meta.at-rule.media.scss",
          "meta.property-list.media-query.scss",
          "meta.property-value.media-query.scss",
          "support.constant.property-value.css",
        ],
      });
      expect(tokens[8]).toEqual({
      ...
      expect(tokens[10]).toEqual({
        value: "and",
        scopes: ["source.css.scss", "meta.at-rule.media.scss", "keyword.operator.logical.scss"],
      });
      expect(tokens[12]).toEqual({
        value: "(",
        scopes: [
  ...
  describe("variable setting", function () {
    it("parses all tokens", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "$font-size",
        scopes: ["source.css.scss", "meta.definition.variable.scss", "variable.scss"],
      });
      expect(tokens[1]).toEqual({
        value: ":",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: " ",
        scopes: ["source.css.scss", "meta.definition.variable.scss"],
      });
      expect(tokens[3]).toEqual({
        value: "$normal-font-size",
        scopes: ["source.css.scss", "meta.definition.variable.scss", "variable.scss"],
      });
      expect(tokens[4]).toEqual({
        value: ";",
        scopes: ["source.css.scss", "punctuation.terminator.rule.scss"],
      });

      ({ tokens } = grammar.tokenizeLine(
        ' $font-family-sans-serif: "Helvetica Neue", Roboto, Arial, sans-serif;',
      ));
    ...
    it("parses css variables", function () {
      ...
      expect(tokens[5]).toEqual({
        value: "--spacing-unit",
        scopes: ["source.css.scss", "meta.property-list.scss", "variable.scss"],
      });
      expect(tokens[6]).toEqual({
        value: ":",
        scopes: [
...
`);
  ...
  describe("interpolation", function () {
    ...
    it("does not tokenize anything after the closing bracket as interpolation", function () {
      ...
      expect(tokens[3]).not.toEqual({
        value: "hi",
        scopes: ["source.css.scss", "variable.interpolation.scss"],
      });
    });
  });
  ...
  describe("comments", function () {
    it("tokenizes line comments", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "//",
        scopes: ["source.css.scss", "comment.line.scss", "punctuation.definition.comment.scss"],
      });
      expect(tokens[1]).toEqual({
        value: "Wow a comment!",
        scopes: ["source.css.scss", "comment.line.scss"],
      });
    });
    ...
    it("tokenizes block comments", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "/*",
        scopes: ["source.css.scss", "comment.block.scss", "punctuation.definition.comment.scss"],
      });
      expect(tokens[1]).toEqual({
        value: "Pretty blocky",
        scopes: ["source.css.scss", "comment.block.scss"],
      });
      expect(tokens[2]).toEqual({
        value: "*/",
        scopes: ["source.css.scss", "comment.block.scss", "punctuation.definition.comment.scss"],
...
`);
  ...
  describe("@use", function () {
    it("tokenizes solitary @use correctly", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "use",
        scopes: ["source.css.scss", "meta.at-rule.use.scss", "keyword.control.at-rule.use.scss"],
      });
    });
    ...
    it("tokenizes @use with path correctly", function () {
      ...
      expect(tokens[4]).toEqual({
        value: "module",
        scopes: ["source.css.scss", "meta.at-rule.use.scss", "string.quoted.single.scss"],
      });
    });
    ...
    it("tokenizes @use with explicit namespace correctly", function () {
      ...
      expect(tokens[7]).toEqual({
        value: "as",
        scopes: ["source.css.scss", "meta.at-rule.use.scss", "keyword.control.operator"],
      });
      expect(tokens[9]).toEqual({
        value: "m-_",
        scopes: ["source.css.scss", "meta.at-rule.use.scss", "variable.scss"],
      });
    });
  ...
  describe("@forward", function () {
    ...
    it("tokenizes @forward with path correctly", function () {
      ...
      expect(tokens[4]).toEqual({
        value: "module",
        scopes: ["source.css.scss", "meta.at-rule.forward.scss", "string.quoted.single.scss"],
      });
    });
    ...
    it("tokenizes @forward with prefix correctly", function () {
      ...
      expect(tokens[7]).toEqual({
        value: "as",
        scopes: ["source.css.scss", "meta.at-rule.forward.scss", "keyword.control.operator"],
      });
      expect(tokens[9]).toEqual({
        value: "prefix",
        scopes: [
          "source.css.scss",
          "meta.at-rule.forward.scss",
          "entity.other.attribute-name.module.scss",
        ],
      });
      expect(tokens[10]).toEqual({
        value: "*",
        scopes: [
          "source.css.scss",
          "meta.at-rule.forward.scss",
          "punctuation.definition.wildcard.scss",
        ],
      });
    });
    ...
    it("tokenizes @forward with hide correctly", function () {
      ...
      expect(tokens[9]).toEqual({
        value: "a-mixin",
        scopes: ["source.css.scss", "meta.at-rule.forward.scss", "entity.name.function.scss"],
      });
      expect(tokens[11]).toEqual({
        value: "$private-variable",
        scopes: ["source.css.scss", "meta.at-rule.forward.scss", "variable.scss"],
      });
    });
