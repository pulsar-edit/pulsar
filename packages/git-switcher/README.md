...
- **Repository tile**: shows the window's active repository; choosing one locks it, while `Auto` follows the active workspace item.
- **Branch tile**: shows the active repository's branch and offers branch creation, start-point selection, and detached checkout.
