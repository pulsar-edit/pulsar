      ...
      <div className='styleguide pane-item native-key-bindings' tabIndex='-1'>
        ...
        <main className='styleguide-sections'>
          ...
          <StyleguideSection onDidInitialize={this.didInitializeSection.bind(this)} name='icons' title='Icons'>
            <p>Pulsar comes bundled with <a href='https://primer.style/design/foundations/icons/'>Octicons</a>. It lets you easily add icons to your packages.</p>
            ...
            <h2>Octicons</h2>
            {this.renderExampleHTML(dedent`
              <span class='icon icon-accessibility'>accessibility</span>
              <span class='icon icon-accessibility-inset'>accessibility-inset</span>
              <span class='icon icon-alert native-key-bindings'>alert</span>
              <span class='icon icon-alert-fill'>alert</span>
              ...
              <span class='icon icon-apps'>apps</span>
              <span class='icon icon-archive'>archive</span>
              <span class='icon icon-arrow-both'>arrow-both</span>
              <span class='icon icon-arrow-down'>arrow-down</span>
              <span class='icon icon-arrow-down-left'>arrow-down-left</span>
              <span class='icon icon-arrow-down-right'>arrow-down-right</span>
              <span class='icon icon-arrow-left'>arrow-left</span>
              <span class='icon icon-arrow-switch'>arrow-switch</span>
              ...
              <span class='icon icon-arrow-up-left'>arrow-up-left</span>
              <span class='icon icon-arrow-up-right'>arrow-up-right</span>
              <span class='icon icon-beaker'>beaker</span>
              <span class='icon icon-beer'>beer</span>
              <span class='icon icon-bell'>bell</span>
              <span class='icon icon-bell-fill'>bell-fill</span>
              <span class='icon icon-bell-slash'>bell-slash</span>
              <span class='icon icon-blocked'>blocked</span>
              <span class='icon icon-bold'>bold</span>
              <span class='icon icon-book'>book</span>
              <span class='icon icon-bookmark'>bookmark</span>
              <span class='icon icon-bookmark-fill'>bookmark-fill</span>
              <span class='icon icon-bookmark-slash'>bookmark-slash</span>
              <span class='icon icon-bookmark-slash-fill'>bookmark-slash-fill</span>
              ...
              <span class='icon icon-cache'>cache</span>
              <span class='icon icon-calendar'>calendar</span>
              <span class='icon icon-check'>check</span>
              <span class='icon icon-checkbox'>checkbox</span>
              ...
              <span class='icon icon-check-circle'>check-circle</span>
              <span class='icon icon-check-circle-fill'>check-circle-fill</span>
              ...
              <span class='icon icon-clock-fill'>clock-fill</span>
              <span class='icon icon-cloud'>cloud</span>
              <span class='icon icon-cloud-download'>cloud-download</span>
              <span class='icon icon-cloud-offline'>cloud-offline</span>
              <span class='icon icon-cloud-upload'>cloud-upload</span>
              <span class='icon icon-code'>code</span>
              <span class='icon icon-codescan'>codescan</span>
              <span class='icon icon-codescan-checkmark'>codescan-checkmark</span>
              <span class='icon icon-codespaces'>codespaces</span>
              <span class='icon icon-code-of-conduct'>code-of-conduct</span>
              <span class='icon icon-code-review'>code-review</span>
              <span class='icon icon-code-square'>code-square</span>
              <span class='icon icon-color-mode'>color-mode</span>
              <span class='icon icon-columns'>columns</span>
              <span class='icon icon-command-palette'>command-palette</span>
              ...
              <span class='icon icon-commit'>commit</span>
              <span class='icon icon-container'>container</span>
              <span class='icon icon-copilot'>copilot</span>
              <span class='icon icon-copilot-error'>copilot-error</span>
              <span class='icon icon-copilot-warning'>copilot-warning</span>
              <span class='icon icon-copy'>copy</span>
              <span class='icon icon-credit-card'>credit-card</span>
              <span class='icon icon-cpu'>cpu</span>
              <span class='icon icon-cross-reference'>cross-reference</span>
              ...
              <span class='icon icon-dependabot'>dependabot</span>
              ...
              <span class='icon icon-diamond'>diamond</span>
              ...
              <span class='icon icon-discussion-closed'>discussion-closed</span>
              <span class='icon icon-discussion-duplicate'>discussion-duplicate</span>
              <span class='icon icon-discussion-outdated'>discussion-outdated</span>
              <span class='icon icon-dot'>dot</span>
              <span class='icon icon-dot-fill'>dot-fill</span>
              <span class='icon icon-download'>download</span>
              <span class='icon icon-duplicate'>duplicate</span>
              <span class='icon icon-ellipses'>ellipses</span>
              <span class='icon icon-ellipsis'>ellipsis</span>
              <span class='icon icon-eye'>eye</span>
              <span class='icon icon-eye-closed'>eye-closed</span>
              <span class='icon icon-eye-unwatch'>eye-unwatch</span>
              <span class='icon icon-eye-watch'>eye-watch</span>
              <span class='icon icon-feed-discussion'>feed-discussion</span>
              <span class='icon icon-feed-forked'>feed-forked</span>
              <span class='icon icon-feed-heart'>feed-heart</span>
              <span class='icon icon-feed-merged'>feed-merged</span>
              <span class='icon icon-feed-person'>feed-person</span>
              <span class='icon icon-feed-repo'>feed-repo</span>
              <span class='icon icon-feed-rocket'>feed-rocket</span>
              <span class='icon icon-feed-star'>feed-star</span>
              <span class='icon icon-feed-tag'>feed-tag</span>
              <span class='icon icon-feed-trophy'>feed-trophy</span>
              <span class='icon icon-file'>file</span>
              <span class='icon icon-file-add'>file-add</span>
              <span class='icon icon-file-added'>file-added</span>
              <span class='icon icon-file-badge'>file-badge</span>
              <span class='icon icon-file-binary'>file-binary</span>
              <span class='icon icon-file-code'>file-code</span>
              <span class='icon icon-file-diff'>file-diff</span>
              <span class='icon icon-file-directory-fill'>file-directory-fill</span>
              <span class='icon icon-file-directory-open-fill'>file-directory-open-fill</span>
              ...
              <span class='icon icon-file-moved'>file-moved</span>
              <span class='icon icon-file-pdf'>file-pdf</span>
              <span class='icon icon-file-removed'>file-removed</span>
              ...
              <span class='icon icon-filter'>filter</span>
              <span class='icon icon-fiscal-host'>fiscal-host</span>
              <span class='icon icon-flame'>flame</span>
              <span class='icon icon-fold'>fold</span>
              <span class='icon icon-fold-down'>fold-down</span>
              <span class='icon icon-fold-up'>fold-up</span>
              ...
              <span class='icon icon-git-merge-queue'>git-merge-queue</span>
              <span class='icon icon-git-pull-request-closed'>git-pull-request-closed</span>
              <span class='icon icon-git-pull-request-draft'>git-pull-request-draft</span>
              <span class='icon icon-globe'>globe</span>
              <span class='icon icon-goal'>goal</span>
              <span class='icon icon-grabber'>grabber</span>
              <span class='icon icon-graph'>graph</span>
              <span class='icon icon-hash'>hash</span>
              <span class='icon icon-heading'>heading</span>
              <span class='icon icon-heart'>heart</span>
              <span class='icon icon-heart-fill'>heart-fill</span>
              <span class='icon icon-history'>history</span>
              <span class='icon icon-home'>home</span>
              <span class='icon icon-home-fill'>home-fill</span>
              ...
              <span class='icon icon-id-badge'>id-badge</span>
              <span class='icon icon-image'>image</span>
              <span class='icon icon-inbox'>inbox</span>
              <span class='icon icon-info'>info</span>
              <span class='icon icon-infinity'>infinity</span>
              ...
              <span class='icon icon-issue-draft'>issue-draft</span>
              <span class='icon icon-issue-tracked-by'>issue-tracked-by</span>
              <span class='icon icon-issue-tracks'>issue-tracks</span>
              <span class='icon icon-italic'>italic</span>
              <span class='icon icon-iterations'>iteractions</span>
              ...
              <span class='icon icon-kebab-horizontal'>kebab-horizontal</span>
              <span class='icon icon-key'>key</span>
              <span class='icon icon-keyboard'>keyboard</span>
              <span class='icon icon-key-asterisk'>key-asterisk</span>
              ...
              <span class='icon icon-log'>log</span>
              ...
              <span class='icon icon-meter'>meter</span>
              ...
              <span class='icon icon-move-to-bottom'>move-to-bottom</span>
              <span class='icon icon-move-to-end'>move-to-end</span>
              <span class='icon icon-move-to-start'>move-to-start</span>
              <span class='icon icon-move-to-top'>move-to-top</span>
              <span class='icon icon-mute'>mute</span>
              <span class='icon icon-multi-select'>multie-select</span>
              <span class='icon icon-no-entry'>no-entry</span>
              <span class='icon icon-no-entry-fill'>no-entry-fill</span>
              <span class='icon icon-no-newline'>no-newline</span>
              <span class='icon icon-north-star'>north-star</span>
              <span class='icon icon-note'>note</span>
              <span class='icon icon-number'>number</span>
              ...
              <span class='icon icon-package-dependencies'>package-dependencies</span>
              <span class='icon icon-package-dependents'>package-dependents</span>
              <span class='icon icon-paintbrush'>paintbrush</span>
              <span class='icon icon-paintcan'>paintcan</span>
              <span class='icon icon-paper-airplane'>paper-airplane</span>
              <span class='icon icon-paperclip'>paperclip</span>
              <span class='icon icon-passkey-fill'>passkey-fill</span>
              <span class='icon icon-paste'>paste</span>
              <span class='icon icon-pencil'>pencil</span>
              <span class='icon icon-people'>people</span>
              <span class='icon icon-person'>person</span>
              <span class='icon icon-person-add'>person-add</span>
              <span class='icon icon-person-fill'>person-fill</span>
              ...
              <span class='icon icon-plus-circle'>plus-circle</span>
              ...
              <span class='icon icon-project'>project</span>
              <span class='icon icon-project-roadmap'>project-roadmap</span>
              <span class='icon icon-project-symlink'>project-symlink</span>
              <span class='icon icon-project-template'>project-template</span>
              ...
              <span class='icon icon-read'>read</span>
              ...
              <span class='icon icon-repo-deleted'>repo-deleted</span>
              <span class='icon icon-repo-locked'>repo-locked</span>
              <span class='icon icon-repo-template'>repo-template</span>
              <span class='icon icon-report'>report</span>
              <span class='icon icon-rel-file-path'>rel-file-path</span>
              <span class='icon icon-rocket'>rocket</span>
              <span class='icon icon-rows'>rows</span>
              ...
              <span class='icon icon-share-android'>share-android</span>
              <span class='icon icon-shield'>shield</span>
              <span class='icon icon-shield-check'>shield-check</span>
              <span class='icon icon-shield-lock'>shield-lock</span>
              <span class='icon icon-shield-slash'>shield-slash</span>
              <span class='icon icon-shield-x'>shield-x</span>
              <span class='icon icon-sidebar-collapse'>sidebar-collapse</span>
              <span class='icon icon-sidebar-expand'>sidebar-expand</span>
              <span class='icon icon-sign-in'>sign-in</span>
              <span class='icon icon-sign-out'>sign-out</span>
              <span class='icon icon-single-select'>single-select</span>
              <span class='icon icon-skip'>skip</span>
              <span class='icon icon-skip-fill'>skip-fill</span>
              <span class='icon icon-sliders'>sliders</span>
              <span class='icon icon-smiley'>smiley</span>
              <span class='icon icon-sort-asc'>sort-asc</span>
              <span class='icon icon-sort-desc'>sort-desc</span>
              <span class='icon icon-sparkle-fill'>sparkle-fill</span>
              <span class='icon icon-sponsor-tiers'>sponsor-tiers</span>
              <span class='icon icon-split'>split</span>
              <span class='icon icon-square'>square</span>
              <span class='icon icon-square-fill'>square-fill</span>
              <span class='icon icon-squirrel'>squirrel</span>
              <span class='icon icon-stack'>stack</span>
              <span class='icon icon-star'>star</span>
              <span class='icon icon-star-fill'>star-fill</span>
              ...
              <span class='icon icon-stopwatch'>stopwatch</span>
              <span class='icon icon-strikethrough'>stikethrough</span>
              <span class='icon icon-sun'>sun</span>
              <span class='icon icon-sync'>sync</span>
              <span class='icon icon-tab'>tab</span>
              <span class='icon icon-tab-external'>tab-external</span>
              <span class='icon icon-table'>table</span>
              ...
              <span class='icon icon-telescope-fill'>telescope-fill</span>
              ...
              <span class='icon icon-trash'>trash</span>
              ...
              <span class='icon icon-trophy'>trophy</span>
              <span class='icon icon-typography'>typography</span>
              <span class='icon icon-unfold'>unfold</span>
              <span class='icon icon-unlink'>unlink</span>
              <span class='icon icon-unlock'>unlock</span>
              <span class='icon icon-unread'>unread</span>
              <span class='icon icon-unmute'>unmute</span>
              <span class='icon icon-upload'>upload</span>
              ...
              <span class='icon icon-video'>video</span>
              <span class='icon icon-watch'>watch</span>
              <span class='icon icon-webhook'>webhook</span>
              <span class='icon icon-workflow'>workflow</span>
              <span class='icon icon-x'>x</span>
              <span class='icon icon-x-circle'>x-circle</span>
              <span class='icon icon-x-circle-fill'>x-circle-fill</span>
              <span class='icon icon-zap'>zap</span>
              <span class='icon icon-zoom-in'>zoom-in</span>
