...
`);
    ...
    describe("attribute selectors", function () {
      ...
      it("tokenises the ignore-case modifier at the end of a selector", function () {
        const { tokens } = grammar.tokenizeLine(
          "a[attr=val i] a[attr=\"val\" i] a[attr='val'I] a[val^=  '\"'i] a[attr= i] a[attr= i i]",
        );
        expect(tokens[6]).toEqual({
          value: "i",
          scopes: [
        ...
        it("highlights invalid @charset statements", function () {
          ...
          expect(lines[0][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.leading-whitespace.charset.css",
            ],
          });
          expect(lines[0][1]).toEqual({
            value: "@",
          ...
          expect(lines[0][4]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.not-double-quoted.charset.css",
            ],
          });
          expect(lines[0][5]).toEqual({
            value: ";",
          ...
          expect(lines[0][2]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.whitespace.charset.css",
            ],
          });
          expect(lines[0][3]).toEqual({
            value: '"',
          ...
          expect(lines[0][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.no-whitespace.charset.css",
            ],
          });
          expect(lines[0][1]).toEqual({
            value: ";",
          ...
          expect(lines[0][6]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.unexpected-characters.charset.css",
            ],
          });
          expect(lines[0][7]).toEqual({
            value: ";",
          ...
          expect(lines[0][3]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.unclosed-string.charset.css",
            ],
          });
          ...
          expect(lines[0][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.charset.css",
              "invalid.illegal.not-lowercase.charset.css",
            ],
          });
          expect(lines[0][1]).toEqual({
            value: " 'US-ASCII'",
        ...
        it("highlights deprecated media types", function () {
          ...
          expect(tokens[7]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.import.css",
              "invalid.deprecated.constant.media.css",
            ],
          });
          expect(tokens[8]).toEqual({
            value: ";",
      ...
      describe("@supports", function () {
        it("tokenises feature queries", function () {
          ...
          expect(tokens[11]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.supports.body.css",
...
`);
          expect(lines[0][3]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.supports.header.css",
              "keyword.operator.logical.feature.not.css",
            ],
          });
          expect(lines[1][11]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.supports.header.css",
              "keyword.operator.logical.feature.and.css",
            ],
          });
          expect(lines[2][11]).toEqual({
            value: "or",
            scopes: [
              "source.css",
              "meta.at-rule.supports.header.css",
              "keyword.operator.logical.feature.or.css",
            ],
          });
        });
...
`);
          expect(lines[0][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.swash.css",
              "keyword.control.at-rule.swash.css",
              "punctuation.definition.keyword.css",
            ],
          });
          expect(lines[0][1]).toEqual({
          ...
          expect(lines[0][2]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.swash.css",
              "meta.property-list.font-feature.css",
              "punctuation.section.property-list.begin.bracket.curly.css",
            ],
          });
          expect(lines[0][4]).toEqual({
          ...
          expect(lines[1][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.ornaments.css",
              "keyword.control.at-rule.ornaments.css",
              "punctuation.definition.keyword.css",
            ],
          });
          expect(lines[1][1]).toEqual({
          ...
          expect(lines[2][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.annotation.css",
              "keyword.control.at-rule.annotation.css",
              "punctuation.definition.keyword.css",
            ],
          });
          expect(lines[2][1]).toEqual({
          ...
          expect(lines[3][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.stylistic.css",
              "keyword.control.at-rule.stylistic.css",
              "punctuation.definition.keyword.css",
            ],
          });
          expect(lines[3][1]).toEqual({
          ...
          expect(lines[5][0]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.character-variant.css",
              "keyword.control.at-rule.character-variant.css",
              "punctuation.definition.keyword.css",
            ],
          });
          expect(lines[5][1]).toEqual({
...
`);
          ...
          expect(lines[0][5]).toEqual({
            ...
            scopes: [
              "source.css",
              "meta.at-rule.counter-style.body.css",
              "punctuation.section.property-list.begin.bracket.curly.css",
            ],
          });
          expect(lines[1][1]).toEqual({
...
`);
        ...
        expect(lines[5][6]).toEqual({
          ...
          scopes: [
            ...
            "meta.property-list.css",
            "meta.property-value.css",
            "meta.function.timing-function.css",
...
`);
            expect(lines[1][4]).toEqual({
              ...
              scopes: [
                ...
                "meta.property-list.css",
                "meta.property-value.css",
                "meta.function.gradient.invalid.deprecated.gradient.css",
    ...
    it("highlights an unterminated string as an error", function () {
      ...
      expect(tokens[7]).toEqual({
        ...
        scopes: [
          ...
          "meta.property-value.css",
          "string.quoted.single.css",
          "invalid.illegal.unclosed.string.css",
        ],
      });
