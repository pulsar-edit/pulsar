...
//
// Used by the fuzzy-finder and [find in project](https://github.com/lumine-editor/lumine/blob/master/src/scan-handler.js).
//
// For a real-world example, see the [scan-handler](https://github.com/lumine-editor/lumine/blob/master/src/scan-handler.js)
// and the [instantiation of the task](https://github.com/lumine-editor/lumine/blob/master/src/project.js).
//
// ## Examples
//
