...
const languages = [
  {
    language: "JavaScript",
    code: "function aFunction() { 10 }",
    checks: { numeric: "10", name: "aFunction" },
  },
  {
    language: "Ruby",
    code: "def a_function\n  10\nend",
    checks: { numeric: "10", name: "a_function" },
  },
  {
    language: "Java",
    code: "public int blah { return 10; }",
    checks: { numeric: "10", type: "int" },
  },
...
function syntaxElement(kind, text) {
  return editor.page.locator(`atom-text-editor.is-focused .syntax--${kind}:text('${text}')`);
}
